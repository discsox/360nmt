    ...
    <div class="ContentNews left">
      ...
      <div class="left">
        <div class="center marginTB2pc"> 
          <p> Summer Special...</p>
          <p>Play Hard<br>
            <span class="gray"><strong>LISA & MIKE HAVE YOUR BACK! </strong></span></p>
        </div>
        <div class="newsPic"><strong><img src="_images/beach_300.jpg" alt="Beach" class="right transition" title="Fannie Koa"></strong>
        </div>
        <div class="textNews">
          <p><strong><em>360 NMT Residents are selected to fast-track post-graduate courses and train closely with our senior staff. 
Resident sessions combine therapeutic massage with trigger point therapy. Perfect for keeping your muscles in tip-top shape all summer!
</em></strong><br><br>
          </p>
        </div>
...
<a href="https://clients.mindbodyonline.com/ASP/ws.asp?studioid=5589&stype=43&prodid=483" target="_blank"><strong>PURCHASE PACKAGE HERE</strong></a><br>
        ...
        <div>
          ...
          <p class="newsFooter">Sessions must be redeemed by 9/30/1</p>
        </div>
      </div>
    </div>
  </div>
