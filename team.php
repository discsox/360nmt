...
<div class="gridContainer clearfix"  <?=$menuFix;?> >
  ...
  <div id="HeaderContainer">
    ...
    <div id="Navigation">
      <nav><!-- #BeginLibraryItem "/Library/navigation.lbi" -->
        <ul>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="TeamList">
    <h1 class="center">360 NMT Team</h1>
    <div id="Team1">
      <ul>
        <li><a href="team/katie.php"><span class="image_rounded"><img src="_images/team/katie_40.jpg" alt="Katie Adams" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Katie Adams</span></a></li>
        <li><a href="team/erika.php"><span class="image_rounded"><img src="_images/team/erika_40.jpg" alt="Erika Bourne" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Erika Bourne</span></a></li>
        <li><a href="team/brendan.php"><span class="image_rounded"><img src="_images/team/brendan_40.jpg" alt="Brendan" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Brendan Carney</span></a></li>
        <li><a href="team/lachlan.php"><span class="image_rounded"><img src="_images/team/lachlan_40.jpg" alt="Lachlan" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Lachlan Croteau</span></a></li>
        <li><a href="team/denise.php"><span class="image_rounded"><img src="_images/team/denise_40.jpg" alt="Denise Devereaux" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Denise Devereaux</span></a></li>
        <li><a href="team/bridget.php"><span class="image_rounded"><img src="_images/team/bridget_40.jpg" alt="Bridget Devine" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Bridget Devine</span></a></li>
        <li class="hideInDesktopOnly"><a href="team/lynn.php"><span class="image_rounded"><img src="_images/team/lynn_40.jpg" alt="Lynn Enos" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Lynn Enos</span></a></li>
        <li class="hideInDesktopOnly"><a href="team/sarah.php"><span class="image_rounded"><img src="_images/team/sarah_40.jpg" alt="Sarah Ernst-Edwards" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Sarah Ernst-Edwards</span></a></li>
        <li class="hideInDesktopOnly"><a href="team/lisa.php"><span class="image_rounded"><img src="_images/lisa_40.jpg" alt="Lisa" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Lisa Gorman</span></a></li>
      </ul>
    </div>
    <div id="Team2">
      <ul>
        <li class="hideInMobileAndTablet"><a href="team/lynn.php"><span class="image_rounded"><img src="_images/team/lynn_40.jpg" alt="Lynn Enos" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Lynn Enos</span></a></li>
        <li class="hideInMobileAndTablet"><a href="team/sarah.php"><span class="image_rounded"><img src="_images/team/sarah_40.jpg" alt="Sarah Ernst-Edwards" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Sarah Ernst-Edwards</span></a></li>
        <li class="hideInMobileAndTablet"><a href="team/lisa.php"><span class="image_rounded"><img src="_images/lisa_40.jpg" alt="Lisa" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Lisa Gorman</span></a></li>
        <li><a href="team/hans.php"><span class="image_rounded"><img src="_images/team/hans_40.jpg" alt="Hans" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Hans</span></a></li>
        <li><a href="team/fannie.php"><span class="image_rounded"><img src="_images/team/fannie_40.jpg" alt="Fannie" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Fannie Koa</span></a></li>
        <li><a href="team/alex.php"><span class="image_rounded"><img src="_images/team/alex_40.jpg" alt="Alex McAlice" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Alex McAlice</span></a></li>
      </ul>
    </div>
    <div id="Team3">
      <ul>
        <li><a href="team/timothy.php"><span class="image_rounded"><img src="_images/team/timothy_40.jpg" alt="Timothy Shaw" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Timothy Shaw</span></a></li>
        <li><a href="team/lisa_r.php"><span class="image_rounded"><img src="_images/team/lisa_r_40.jpg" alt="Lisa Rotondi" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Lisa Rotondi</span></a></li>
        <li><a href="team/ean.php"><span class="image_rounded"><img src="_images/team/ean_40.jpg" alt="Ean Spangler" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Ean Spangler</span></a></li>
        <li><a href="team/peter.php"><span class="image_rounded"><img src="_images/team/peter_40.jpg" alt="Peter Stone" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Peter Stone</span></a></li>
        <li><a href="team/nicole.php"><span class="image_rounded"><img src="_images/team/nicole_40.jpg" alt="Nicole Teter-Downin" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Nicole Teter-Downin</span></a></li>
        <li><a href="team/stew.php"><span class="image_rounded"><img src="_images/team/stew_40.jpg" alt="Stewart Wild" width="40" height="29" class="absmiddle"></span><span class="textTeamList">Stewart Wild</span></a></li>
      </ul>
    </div>
  </div>
  <div id="GenText">
    <p>&nbsp;</p>
    <p class="center">"<em>I am forever grateful to all the therapists at 360 who helped put my body back together again.</em>"  ~DG, 2013</p>
  </div>
  <!-- InstanceEndEditable -->
  ...
  <div id="Footer">
    ...
    <div id="Footer4">
      ...
      <p class="address"> 35 Highland Circle, 2nd Floor<br>
        Needham, MA 02494<br>
