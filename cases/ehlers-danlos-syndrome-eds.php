...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Ehlers Danlos Syndrome (EDS)</h1>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/ehlers_danlos_13.jpg" alt="CPPS" class="right marginL3pc marginB2pc "></span><em>Case example coming soon. </em></p>
<!--    <p class="TitleUnderlined">Presenting symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/ehlers_danlos_13.jpg" alt="CPPS" class="right marginL3pc marginB2pc "></span>A 17 year-old student  was sent to 360 NMT by her primary care doctor for help with multi-region  chronic pain as a result of Ehlers–Danlos Syndrome (EDS). Her complex medical  history also included three motor vehicle accidents within one calendar year.  She complained of lingering neck pain from (whiplash), as well as migraines (nausea  and photophobia), fainting, chronic fatigue, and sundry other headaches (ice  pick). Past and ongoing conditions included Postural Orthostatic Tacchycardia  Syndrome, dizziness, and poor GI motility. Prior treatments for the pain had  included biofeedback, guided imagery, and cognitive behavior therapy.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">Ehlers–Danlos Syndrome is a rare genetic condition where the body produces faulty collagen, elastin or other connective tissue. This connective tissue weakness results in hypermobility, joint instability, sleep disturbances and most troubling to this patient, pain. Trigger points are common, but interestingly, by taking up space, trigger points can add to joint stability. Therefore, it may be useful to deactivate a few, but not too many.</p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">Treatment began with  cutaneous super-stimulation techniques. These 360 NMT signature non-painful stimulations  can be in the form of vibration, warm/cold, light pressure on the skin, as well  as jostling and snapping. We also employ sharp sensations from a variety of  spiky implements. These techniques make use of the &lsquo;gate control&rsquo; theory to  reduce muscle pain. Next, some of the trigger points were located and  deactivated in the trapezius and levator scapulae, SCM, paraspinals,  intercostals and diaphragm.</p>
    <p class="TitleUnderlined">      Outcomes and  follow-up</p>
    <p class="textInfoStyle">While some positive  changes were made, the patient continued to have intermittent headaches and the  dizziness remained unchanged. She did have improvements in the GI motility and  breathing. She was given homecare activities for continued self-treatment.</p>-->
    <div class="linkBoxWhite"><a href="pain-syndromes.php">&lt;-Back to Pain Syndromes</a></div>
  </div>
  <!-- InstanceEndEditable -->
