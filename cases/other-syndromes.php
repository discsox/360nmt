...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentTxt">
    <h2 class="center">Other Issues    </h2>
    <p class="MainTxt"><img src="../_images/body_map.png" alt="Body Map" name="bodies" id="bodies"></p>
  ...
  <div id="ContentTxt_right">    
    ...
    <p class="conditionList">
      <strong><a href="amenorrhea-acupuncture.php" class="conditionLink" id="AA">Amenorrhea - Acupuncture</a></strong><br>
      <strong><a href="emotional-stress.php" class="conditionLink" id="ES">Emotional  Stress</a></strong><br>
      <strong><a href="muscle-damage-severe.php" class="conditionLink" id="MDS">Muscle Damage (severe)</a></strong><br>
      <strong><a href="muscle-deconditioning.php" class="conditionLink" id="MD">Muscle Deconditioning</a></strong><br>
      <strong><a href="muscle-imbalance.php" class="conditionLink" id="MI">Muscle Imbalance</a></strong><br>
      <strong><a href="nutrition-digestion.php" class="conditionLink" id="ND">Nutrition / Digestion</a></strong><br>
      <strong><a href="performance-maintenance.php" class="conditionLink" id="PM">Performance Maintenance</a></strong><br>
      <strong><a href="postural-distortion.php" class="conditionLink" id="PD">Postural Distortion</a></strong><br>
      <strong><a href="repetitive-strain-injury.php" class="conditionLink" id="PD">Repetitive Strain Injury</a></strong></p>
    <p>&nbsp;</p>
