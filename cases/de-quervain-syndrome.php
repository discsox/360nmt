...
<title>De Quervain's Syndrome</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">De Quervain's Syndrome    </h1>
    <p class="textInfoStyle">
    <span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/de_quervain_syndrome_10.jpg" alt="abdominal pain" class=" "></span></p>
    <p class="textInfoStyle">360 NMT can assist de Quervain&rsquo;s Syndrome by specifically treating the abductor pollicis longus and extensor pollicis brevis, as well as other contributing strained forearm muscles.</p>
    <p class="textInfoStyle">Brukner &amp; Khan&rsquo;s <U>Clinical Sports Medicine</U>, 4th Edition, defines <em>&ldquo;De Quervain&rsquo;s tenosynovitis is an inflammation of the synovium of the abductor pollicis longus and extensor pollicis brevis tendons as they pass in their synovial sheath in a fibro-osseous tunnel at the level of the radial styloid. This is the most common radial-sided tendinopathy in sportspeople and occurs particularly with racquet sports, ten-pin bowlers, rowers, and canoeists. The left thumb of a right-handed golfer is particularly at risk because of the hyperabduction required during a golf swing. There is a local tenderness and swelling, which may extend proximally and distally along the course of the tendons.&rdquo;</em></p>
    <p class="textInfoStyle"><strong>Brukner, Peter, and Karim Khan. Brukner &amp; Khan's Clinical Sports Medicine. North Ryde, N.S.W.: McGraw-Hill Education, 2011. 357+. Print.</strong></p>
