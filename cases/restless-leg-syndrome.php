...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Restless Leg Syndrome</h1>
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/restless_leg_ 44.jpg" alt="Restless Leg Syndrome" class="right marginL3pc marginB2pc "></span><em>Case examle coming soon. </em> </p>
