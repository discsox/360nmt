...
<title>Achilles Tendinosis</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Achilles Tendinosis</h1>
    <p class="TitleUnderlined">Presentating symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/achilles_tendinosis_2.jpg" alt="achilles"></span>A 50 year-old male was referred by his podiatrist for Achilles  tendinosis. The doctor wanted him to receive NMT treatment in conjunction with  a course of physical therapy.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">360 NMT communicated with the patient&rsquo;s physical  therapist to coordinate care. Postural analysis and muscle testing revealed  that the tendon was under additional load from faulty knee/hip alignment due to  hip muscle weakness. The Achilles tendon was palpated and found to be very  tender and swollen. </p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">NMT application focused on decreasing muscle density  and trigger point activity in the calf (especially the distal soleus) and foot  muscles. Cross-friction work to the tendon was performed to tolerance. Four  neuromuscular treatments helped alleviate local calf tenderness and swelling at  the Achilles tendon. Next, the external hip rotators and muscles behind the  knee were examined. Weakness was found in the hip along with the faulty knee  alignment pattern. Both added to the strain on his Achilles tendon. Eight more  weeks of combined PT and NMT treatment to the entire lower extremity resolved  this issue.</p>
    <p class="TitleUnderlined">      Outcomes and  follow-up</p>
    <p class="textInfoStyle">This collaboration between massage therapy and  physical therapy produced positive and speedy patient outcomes. 360 NMT focused  on treating the soft-tissue dysfunction in the lower extremity while physical  therapy concurrently worked to strengthen the calf and hip muscles.    </p>
