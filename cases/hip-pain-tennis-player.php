...
<title>Hip Pain (Tennis Player)</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
<div id="GenText">
      <h1 class="center">HIP PAIN  (tENNIS pLAYER)</h1>
      <p class="TitleUnderlined clearBoth">Presenting symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/hip_pain_tennis_19.jpg" alt="Hip pain"></span>A 50-year  old, competitive tennis player presented with limited mobility in the left hip.  She described three surgeries to the right knee including a partial  replacement. Her main reason for seeking treatment was a constant feeling of a  &ldquo;tight band&rdquo; around the left hip and pain after prolonged activity. She was  concerned that she had overused her left hip initially when playing tennis  before surgery, and later while recuperating and using crutches.    </p>
    <p class="TitleUnderlined"> Evaluation,clinical reasoning &amp; treatment strategizing
    </p><p class="textInfoStyle">Postural  analysis indicated an increased anterior pelvic tilt on the left side. She was  observed to limp slightly and favor the left leg. Palpation revealed increased  muscle density and trigger points in the five adductors, the hip flexors,  tensor fascia latae, and the gluteal muscles.    </p>
    <p class="TitleUnderlined">Treatment:</p>
    <p class="textInfoStyle">Neuromuscular  treatments were coordinated with physical therapy and athletic training.  Initially, treatments focused on decreasing the muscle density and trigger  points of the adductors and hip flexors. The client noticed changes after the  first session.  Next, quadriceps,  hamstrings, gluteal, and deep lateral rotator muscles were treated.</p>
    <p class="TitleUnderlined">Results and follow-up      </p>
    <p class="textInfoStyle">After  three months of weekly treatments she was back to her regular practice and game  schedule. The combination of neuromuscular therapy, physical therapy, and  activity specific strengthening exercises allowed the client to recover faster  and stronger than conventional rehabilitation alone. Treatment continues on an &lsquo;<em>as needed&rsquo;</em> basis for maintenance. </p>
