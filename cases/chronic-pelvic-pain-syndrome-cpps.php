...
<title>Chronic Pelvic Pain Syndrome (CPPS)</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Chronic Pelvic Pain Syndrome (CPPS)</h1>
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/chronic_pelvic_pain_6.jpg" alt="buttock pain" class="right marginL3pc marginB2pc "></span>&ldquo;There are no recipes, prediction rules or guidelines for patients presenting with chronic pelvic disability with or without pain and it is likely that a multimodel approach will always be more effective for long-term success.&rdquo; (Chaitow, L., <em>Chronic Pelvic Pain and Dysfunction: Practical Physical Medicine. </em>Elsevier Churchill Livingston, 2012)<BR>
      </p>
      <p class="textInfoStyle">It is suggested that approximately 15-20% of women and 8% of men in the US population have experienced CPPS. Most cases have some soft-tissue involvement in which 360 NMT can assist. We also have built collaborative relationships with physical therapists and physicians to successfully treat patients using a multimodal approach. Please see our resources section for pelvic pain specialists.<BR>
      </p>
      <p class="textInfoStyle"><a href="http://leonchaitow.com/category/blog/">Dr. Chaitow&rsquo;s blog</a> offers good resources and information on Chronic Pelvic Pain Syndrome. <BR>
      </p>
