...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Dizziness</h1>
    <p class="TitleUnderlined">Presenting symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/dizziness_11.png" alt="dizziness" class="right marginL3pc marginB2pc "></span>A 37 year-old male presented with intermittent dizziness that he first experienced after a long flight to Australia. He was referred to 360 NMT by a spine center to treat and/or rule out soft-tissue contributions to symptoms. He described a ‘weird feeling’ of something crackling out of his head, like ‘antennae.’ He had been seen by many specialists and had an MRI, CT scan, and vestibular testing. Results were negative for disease pathologies and benign positional vertigo.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">Postural analysis showed rounding of both shoulders  and reduced cervical lordotic curve (i.e. flattening of the neck). Dizziness worsened  with bilateral head rotation, extension and flexion. Pain increased with  stress, travel, computer and smartphone use.</p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">Three months of bi-weekly treatments deactivated trigger  points referrals in the sternocleidomastoid, upper trapezius, suboccipital  group, and scalene group. Corrective postural activities were recommended along  with self-treatment techniques and modifications to activities of daily living.  Additional therapy on the pectoralis major and minor, trapezius, rhomboids, and  levator scapula muscles helped to maintain posture improvements.</p>
    <p class="TitleUnderlined">      Outcomes and  follow-up</p>
    <p class="textInfoStyle">The patient&rsquo;s symptoms reduced on a pain scale of 1-10  from an 8 to a 2. He modified his ergonomics on the tablet computer he  used during long flights. Physical therapy was recommended to reinforce the  soft-tissue changes and strengthen the posterior neck. NMT maintenance treatments are ongoing to prevent  recurrence.</p>
