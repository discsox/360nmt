...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">SACROILIAC JOINT DISORDERS </h1>
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/si_joint_46.jpg" alt="Socroiliac Joint Disorders" class=" "></span><em>The concept of the SIJ as a pain generator is now well established. However, the evaluation and treatment of SIJ dysfunction remains controversial. One issue is the broad categorization and terminology utilized for the anatomical etiologies of the pain by various health professionals. Controversy also exists because of the complex anatomy and biomechanics of the SIJ.</em></p>
      <p class="textInfoStyle">Brukner, Peter, and Karim Khan. Brukner & Khan's Clinical Sports Medicine. North Ryde, N.S.W.: McGraw-Hill Education, 2011. 357+. Print.</p>
      <p class="textInfoStyle">360 NMT is able to treat soft tissue components of cases with SI joint disorders. v</p>
