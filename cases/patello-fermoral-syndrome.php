...
<title>Patello-Fermoral Syndrome</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Patello-Fermoral Syndrome</h1>
    <p class="TitleUnderlined">Presenting symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/patello_femoral_syndrome_35.jpg" alt="patello-fermoral syndrome" class="right marginL3pc marginB2pc "></span>A 24 year-old squash player had developed pain  superior to, and under, both of her kneecaps and had been diagnosed with PFS. Within  a three-year period of pain she had had a total of nine months Physical Therapy.  She still described episodic, grinding pain with movement that was worse with the  stop-start movements of squash and also when wearing high heels. Despite the  pain she continued to run 2-3 miles at a time, use the elliptical machine, practice  yoga and lift free-weights. She came to 360 NMT when the knee started to ache  even without movement.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">Observation and palpation assessment revealed bilateral  bow legs, more on the right than the left. The left arch of the foot was  flattened, so a Navicular Drop Test was performed confirming hyper-pronation on  weight-bearing. The prone bent leg fallout test (for the extensors and external  rotators of the hip) revealed hypermobility. Strengthening these muscles was  recommended.</p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">Because PFS is primarily an overuse syndrome,  improving strength and retraining lower extremity movement patterns is essential.  Initial 360 NMT treatments focused on quadriceps muscles that could harbor  trigger points and sourcing the general &ldquo;ache&rdquo; sensation. Muscle activation was  encouraged with stimulation to external hip rotators. Home care activities for  arch-strength were recommended.</p>
    <p class="TitleUnderlined">      Outcomes and  follow-up</p>
    <p class="textInfoStyle">This is a new and ongoing case. We will retest to monitor progress of rehabilitation of her left arch and posterior hip, while continuing to treat muscles that can contribute PFS pain.</p>
