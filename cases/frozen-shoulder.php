...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Frozen Shoulder</h1>
    <p class="TitleUnderlined">Presenting symptoms </p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/frozen_shoulder_16.jpg" alt="frozen shoulder"></span>A 23 year-old woman caught an edge while ski racing and landed heavily on her left shoulder. Imaging revealed a fractured shoulder blade and a 3-cm tear in the rotator cuff. Physical therapy reduced pain and improved range of motion, but she subsequently developed a frozen shoulder. Her orthopedist recommended including NMT to her program before making any surgical decisions.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">The causes of frozen shoulder, sometimes called  adhesive capsulitis, are not fully understood. In this case, 360 NMT hoped to  expedite the &ldquo;thawing&rdquo; process by first treating what we call the &ldquo;big four&rdquo;  muscle culprits of a frozen shoulder: lower trapezius, pectoralis minor,  serratus anterior and subscapularis. Later, other cuff and shoulder girdle  muscles are included in the protocol. </p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">Trigger points found in all of the rotator cuff  muscles referred pain directly into her shoulder joint.  To be thorough, we also treated  scapula-thoracic and neck muscles. Local stretch, myofascial release and muscle  energy techniques all helped to reduce pain and make small, steady  improvements. NMT was able to keep other functionally related shoulder muscles  healthy while she continued her therapeutic exercises prescribed by physical  therapy.</p>
    <p class="TitleUnderlined">      Outcomes and follow-up</p>
    <p class="textInfoStyle">Ultimately, this patient was recommended to have a  surgical repair for the cuff tear. Once healed, NMT continued post-operatively  at two-week intervals to expedite recovery. When integrated into pre/post  surgical rehabilitation programs, NMT can help reduce pain, reduce secondary  trigger point dysfunction related to injury and restore muscle health. The  patient returned to ski racing.</p>
