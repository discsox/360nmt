...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">IT Band Friction Syndrome</h1>
<p class="TitleUnderlined clearBoth">Introduction</p>
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/it_band_friction_syndrome.jpg" alt="Hip pain"></span>The  knee separates and connects the two longest bones in the body. Because most of  the body&rsquo;s weight bears down on these bones, it is vital to keep the knee  happy. We often tell clients that the knee doesn&rsquo;t have a brain. It is told  where to be and what to do by mess-ages coming down from the hip and up from  the foot. Many structures help stabilize this inherently unstable stacking of  bones, including the iliotibial band.</p>
      <p class="TitleUnderlined">Iliotibial Band Anatomy 101</p>
      <p class="textInfoStyle">The iliotibial  band runs down the lateral thigh and stabilizes the knee by preventing unwanted  adduction. This band is a thickening of the fascia lata that envelops the whole  of the thigh, like a stocking. The ITB could be considered the tendon of two  muscles; the tensor fascia lata (TFL) in the front, and the gluteus maximus at  the rear. Both act as the upper tensioning and positioning &lsquo;<em>brains&rsquo; </em>of the knee. The lower ITB attachments  are complex. Some fibers split to attach to the lateral femoral condyle (Kaplan&rsquo;s  fibers) and may merge into the patella, some can attach to the head of the  fibula. Most attach to the tibia (Gerdy&rsquo;s tubercle). Underneath is a richly  innervated and vascularized layer of fat and connective tissue (instead of the  traditional bursa). In ITB friction syndrome (ITBFS), the lateral femoral  condyle is where the point tenderness occu=rs. We see this often in runners and  cyclists.</p>
      <p class="TitleUnderlined">Top-Down Influences on ITBFS</p>
      <p class="textInfoStyle">Andry  Vleeming, editor of the classic text &lsquo;<em>Movement, Stability and Lumbopelvic Pain,&rsquo;</em> likens the body&rsquo;s action of shifting the weight onto one leg when walking or  running to &lsquo;<em>pole dancing&rsquo;</em>. As your  weight transfers laterally you press the contents of your thigh against the  rigid &lsquo;<em>pole&rsquo;</em> of the ITB. Runners  often have weak hip abductors causing the opposite hip to drop (not rise) when  in the stance phase. This varus-like (bowing) effect creates extra compressive  and shear forces on structures pushing into the distal ITB attachments leading  to tissue damage, swelling , inflammation and pain.</p>
      <p class="TitleUnderlined">Bottom-Up Influences on ITBFS</p>
      <p class="textInfoStyle">Bear  in mind you can have both top-down and bottom-up influences on the ITB. Poor  rear foot mechanics and hyper-pronation can cause to excessive internal  rotation of the tibia. This mal-position means that the distal ITB attachment  ends up with more medial rotation, once again leading to more compression and  shear forces as the structures underneath push into it. Running on cambers or  circular tracks exacerbates this.</p>
      <p class="TitleUnderlined"><strong>You Can&rsquo;t Stretch A Pole</strong></p>
      <p class="textInfoStyle">The  ITB cannot be stretched. Foam rolling, while beneficial, mostly affects vastus  lateralis, the powerful quadriceps muscle that lies under the ITB (another  structure that pushes out against the iliotibial &lsquo;pole&rsquo; when bearing weight).  Before considering an invasive procedure for ITBFS, we recommend: improve top-down  and bottom-up biomechanics, reduce trigger points within and stretch the two  proximal muscles (TFL and gluteus maximus), strengthen hip lateral rotators and  abductors, and correct any aberrant foot mechanics. </p>
    <div class="linkBoxWhite"><a href="leg-and-foot.php">&lt;-Back to Leg &amp; Foot</a></div>
  </div>
  <!-- InstanceEndEditable -->
