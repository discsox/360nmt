...
<title>Chronic Regional Pain Syndrome (CRPS)</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
    <h1 class="center">Chronic Regional Pain Syndrome (CRPS)</h1>        
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/crps_7.jpg" alt="abdominal pain" class=" "></span>360  NMT can assist with muscle spasms, weakness and stiffness associated with CRPS  Type 1 when nerve damage cannot be immediately identified (also referred to as Reflex  Sympathetic Dystrophy or RSD). Using various mechanoreceptor and manual  techniques, we have had success reducing muscular sourced pain, allodynia  and/or hyperalgesia. Improvement and even remission of complex regional  pain syndrome is possible if treatment begins within a few months of symptoms.    </p>
