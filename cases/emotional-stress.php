...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Emotional Stress</h1>
    <p class="textInfoStyle">
    <span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/emotional_stress_12.jpg" alt="abdominal pain" class=" "></span>“Quantitative research reviews show that a series of massage therapy treatments consistently produce sizable reductions of depression in adult recipients. The effects of massage therapy on anxiety are even better understood ... [and] are especially important for us to understand not only for their own sake, but also because anxiety and depression exacerbate many other specific health problems.” </p>
    <ul>
      <li class="textInfoStyle"><em>	From Affective Massage Therapy, by Christopher A. Moyer, PhD. International Journal of Therapeutic Massage and Bodywork – Volume1, Number 2    </em></li>
    </ul>
    <p class="textInfoStyle"> 360 NMT respects the influential role that emotional stress plays on the musculoskeletal system. Each person processes pain differently and pain can increase anxiety. We pay particular attention to anxiety, as it may then lead to insomnia, depression and fear of movement. 
</p>
    <p class="textInfoStyle">NeuroMuscular Therapy is an advanced massage modality based on a bio-psycho-social model. Our sessions can be mindfully tailored to reduce pain and emotional stress by including relaxation techniques for overall stress management. </p>
