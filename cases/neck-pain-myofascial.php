...
<title>Neck Pain - Myofascial</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Neck Pain - Myofascial</h1>
    <p class="TitleUnderlined">Presenting symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/neck_toticolis_30.jpg" alt="neck pain myofascial" class="right marginL3pc marginB2pc "></span>An overworked computer data processor presented  with left shoulder pain that radiated down her lateral arm and into her wrist.  She described a &ldquo;heaviness and stiffness&rdquo; with tingling into the first three  fingers, especially in the morning. Pain was worse with activities involving  sustained forearm flexion: typing, holding a newspaper, cooking, driving and  grooming.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">We  needed to rule out the soft-tissue entrapment possibilities of four major  nerves of the arm: the musculocutaneous nerve as it passes through the  coracobrachialis muscle, the ulnar nerve as it passes through flexor carpi  ulnaris, the radial nerve as it passes through supinator, and the median nerve  as it passes through the two heads of pronator teres. Postural evaluation  showed rounded shoulders bilaterally and increased thoracic kyphosis. Her range  of motion was limited during shoulder flexion and abduction, and she felt pain  lowering her arm. She was unable to externally rotate her arms well and could  not supinate her forearms more than 45 degrees.  Exquisite, focal tenderness was palpated in  many arm and forearm muscles. There  was a positive Tinel&rsquo;s sign over the median nerve at the elbow.</p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">Positive changes were made when freeing up the  pathway of the median nerve in its relationship to the two heads of pronator  teres where it exits the muscle a third of the way down the forearm. Sustained  shearing pressure, lateral rolling, and pin and stretch techniques were  followed by gentle rhythmic pronation / supination movements with compression.  The ability of the nerve to move freely was reinforced by gentle repeated  stretches of pronator teres.</p>
    <p class="TitleUnderlined">      Outcomes and  follow-up</p>
    <p class="textInfoStyle">Three NMT treatments made significant improvements.  Once the forearm muscles became more extensible, tingling symptoms from the  soft-tissue entrapment of the median nerve improved. Improvements to her ergonomics  and fewer prolonged, fixed postural positioning were emphasized. It was  suggested that she break up her workday activities with movements such as the &ldquo;Wall  Angel&rdquo; sequence for the shoulder, as found on the <a href="http://360nmt.com/blog/index.php" target="_blank">360 NMT blog</a>.</p>
