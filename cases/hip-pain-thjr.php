...
<div id="GenText">
      <h1 class="center">HIP PAIN  (Total Hip Joint Replacement)</h1>
      <h2 class="center WhiteBox marginB20"><em>&ldquo;amazing, what you don&rsquo;t do because you are afraid&rdquo;</em></h2>
<p class="TitleUnderlined clearBoth">Presenting Symptoms</p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/hip_pain_2_21.jpg" alt="Hip pain"></span>Seven weeks after a right-sided<strong> </strong>Total Hip Joint Replacement (THJR), a 51 year-old female patient  was referred for neuromuscular therapy by her physical therapist. She presented  with hamstring pain that increased with walking. She was afraid to continue  with PT exercises until the hamstring pain resolved. </p>
    <p class="textInfoStyle">This patient had previously been diagnosed with<strong> </strong>Right Congenital Hip Dysplasia which  became symptomatic after giving birth to her second child. In 2007, she  underwent a right hip resurfacing procedure for a labrum tear. She was  symptom-free for five years. In 2012, metallosis (a build-up of cobalt and  chromium ions in the soft tissue of the body) was discovered due to  metal-on-metal in the resurfaced hip. Consequently, she was underwent the THJR.    </p>
    <p class="TitleUnderlined"> Evaluation, clinical reasoning &amp; treatment strategizing
    </p><p class="textInfoStyle">Post-op leg length inequalities can result from total  hip joint replacements. The physical therapist found a discrepancy and put a ¼  in lift in the left heel to equalize hip height. However, this did not resolve  the hamstring symptoms. While evaluating the patient&rsquo;s performance of prone hip  extension we observed an incorrect muscle activation pattern. Her right  hamstring fired long before the gluteus maximus and contralateral paraspinals when  she lifted her straight leg toward the ceiling, indicating that her hamstring may  be overworking in compensation for a weakened right hip.    </p>
    <p class="TitleUnderlined">Treatment</p>
    <p class="textInfoStyle">Cross fiber friction was used at the upper hamstring  attachment on the pelvis. We employed a &ldquo;muscle play&rdquo; technique to release  adhesions between the hamstrings and the overlying gluteus maximus tissue.  After separating the hamstring from the gluteal muscle, the patient was taught to  perform the extension exercise correctly by activating her gluteal muscles. </p>
    <p class="TitleUnderlined">Results and follow-up      </p>
    <p class="textInfoStyle">360 NMT was able to resolve the hamstring symptoms  quickly. The movement dysfunction was caught very early, so a pattern did not  have the opportunity to establish itself. The patient was able to return  confidently to her post-surgical rehabilitation. She was able to walk without  pain. </p>
    <div class="linkBoxWhite"><a href="pelvis-and-hip.php">&lt;-Back to Pelvis &amp; Hip</a></div>
  </div>
  <!-- InstanceEndEditable -->
