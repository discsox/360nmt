...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
    <h1 class="center">Sciatic Pain</h1>
    <p class="TitleUnderlined">Presenting symptoms    </p>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/sciatic_pain_47.jpg" alt="Sciatic Pain" class=" "></span>A 52  year-old woman sought muscular treatment for low back pain and severe sciatic  pain. Her job required sitting for long periods of time (a known source of  sciatica). Acute symptoms began when she leaned over to pick up a fallen pen.  MRI imaging showed no significant lumbar pathology. Physical Therapy treatment  had been focusing on stretch and strengthening exercises when she started at  360 NMT.</p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing    </p>
    <p class="textInfoStyle">After an extensive palpation screen for tenderness,  active and latent trigger points were found in the gluteus medius and  piriformis muscles that reproduced pain experienced in her posterior thigh. The  proposed treatment needed to be gentle to avoid further irritation of the  sciatic nerve in the gluteal region. </p>
<p class="TitleUnderlined"> Treatment    </p>
<p class="teamTxt">Myofascial unwinding and gentle trigger point deactivation were applied to the gluteal region. The gluteus minimus actually proved to be the key pain culprit (Travell &amp; Simons in their book &lsquo;<em>Myofascial Pain and Dysfunction&rsquo;</em> refer to gluteus minimus as the &ldquo;pseudo-sciatica&rdquo; muscle). NMT glides, compression with active contraction, and muscle energy techniques helped restore good resting length of gluteal muscles. The TFL muscle was treated in a side-lying position. Satellite trigger points were later deactivated in her posterior thigh, which diminished the rest of her familiar, residual pain. </p>
<p class="teamTxt">&nbsp;</p>
<p class="TitleUnderlined">      Outcomes and  follow-up    </p>
<p class="teamTxt">Despite the severity of her initial symptoms, pain-free movement was obtained after just four sessions. Since NMT was quickly added into her program, this patient was able to complete a course of Physical Therapy without recurrence of the sharp, shooting pain. She continues to receive NMT every 6-8 weeks for maintenance and continues to perform a lumbo-pelvic strengthening homecare program. </p>
<p class="teamTxt">&nbsp;</p>
