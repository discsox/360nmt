...
<title>Torso and Back Pain</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentTxt">
    <h2 class="center">Torso &amp; back</h2>
    <p class=" WhiteBox center marginB20">Click a region of the body map...</p>
    <p class="MainTxt"><img src="../_images/torso_back.png" alt="Body Map" name="arm" usemap="#Map" id="arm">
      <map name="Map"><area shape="circle" coords="170,92,42" href="post-mastectomy-pain.php" data-key="ME"><area shape="poly" coords="382,110,386,123,382,134,402,143,418,149,437,150,439,109,434,81,422,63,405,50,391,48,381,65" href="breathing-pattern-disorder.php" data-key="BPD"><area shape="poly" coords="301,103,302,127,308,151,329,147,347,139,361,129,357,112,355,94,357,65,343,45,323,54,309,76" href="breathing-pattern-disorder.php" data-key="BPD"><area shape="poly" coords="60,103,61,127,67,151,88,147,106,139,120,129,116,112,114,94,116,65,102,45,82,54,68,76" href="breathing-pattern-disorder.php" data-key="BPD"><area shape="poly" coords="345,203,392,203,439,220,439,236,410,257,370,276,325,257,300,235,300,218" href="low-back-pain-lbp.php" data-key="LBP">
        <area shape="poly" coords="197,236,198,215,193,192,125,187,61,194,56,222,59,242,102,264,161,265" href="abdominal-pain.php" data-key="AP">
        <area shape="poly" coords="359,43,360,254,368,289,374,289,382,253,382,43" href="#" data-key="SC">
        <area shape="poly" coords="166,381,206,373,210,383,219,386,202,398,163,403,169,392" href="#" alt="Carpal Tunnel" data-key="CTS">
        <area shape="poly" coords="133,112,139,125,135,136,155,145,171,151,190,152,192,111,187,83,175,65,158,52,144,50,134,67" href="breathing-pattern-disorder.php" data-key="BPD">
        <area shape="circle" coords="93,90,42" href="post-mastectomy-pain.php" data-key="ME">
      </map>
  ...
  <div id="ContentTxt_right">    
    ...
    <p class="conditionList">
      <strong><a href="abdominal-pain.php" class="conditionLink" id="AP">Abdominal  Pain</a></strong><br>
      <strong><a href="breathing-pattern-disorder.php" class="conditionLink" id="BPD">Breathing  Pattern Disorder</a></strong><br>
      <strong><a href="herniated-disc.php" class="conditionLink" id="SC">Herniated  Disc</a></strong><br>
      <strong><a href="low-back-pain-lbp.php" class="conditionLink" id="LBP">Low  Back Pain</a></strong><br>
      <strong><a href="post-mastectomy-pain.php" class="conditionLink" id="ME">Mastectomy  (post-op pain)</a></strong><br>
      <strong><a href="scoliotic.php" class="conditionLink" id="SC">Scoliosis</a></strong><br>
    </p>
    <p>&nbsp;</p>
...
<script language="javascript">
  $(document).ready(function() {	    
	  ...
	  areas:  [{
            ...
            {
                key: "LBP",
               toolTip: "Low Back Pain"
            },
            {
                key: "BPD",
               toolTip: "Breathing Pattern Disorder"
            },
            {
                key: "DQS",
