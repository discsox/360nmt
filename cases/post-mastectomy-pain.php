...
<title>Post Mastectomy Pain</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Post Mastectomy Pain</h1>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/post_mastectomy_41.jpg" alt="post mastectomy pain" class="right marginL3pc marginB2pc "></span>Myofascial Pain Syndrome can develop from many  different surgical breast procedures, including mastectomy, lumpectomy, breast  reduction and reconstruction. This case is an example of complex myofascial  pain developing after a Latissimus  Dorsi Flap Reconstruction.</p>
     <p class="TitleUnderlined"><strong>Presenting symptoms</strong></p>
     <p class="textInfoStyle">This patient had had a bilateral mastectomy with  latissimus dorsi flap reconstruction. Following the surgeries she developed consistent  contractility of the latissimus muscle (more than should be expected from this  procedure) causing discomfort, myofascial  pain, scapular dyskinesis (spastic, poorly coordinated movement) and  severe scar sensitivity. Botulinum toxin injections to the latissimus muscle  had proven ineffective to reduce contractility. She was referred to 360 NMT by  her Physiatrist. </p>
    <p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>
    <p class="textInfoStyle">The latissimus was found to be in a constant state  of contraction, creating a relentless pulling sensation at her right axilla  region (armpit). There appeared to be increased tightening in muscles  compensating for latissimus (subsacpularis, teres major and lumbar paraspinals)  that also contributed to dysfunctional movement patterns. The repositioned  latissimus was firing with protraction (pushing forward) and had also become  adhered to pectoralis major. Poor dynamic stability of the shoulders was  observed.&nbsp; The treatment plan was to include sensory distraction, decrease  of the trigger point activity in the rotator  cuff muscles, and work on the force-couple muscles of the shoulder to  improve biomechanics</p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">NMT treatment began by addressing all the muscles  functionally affected by the repositioning of the latissimus muscle. Initial  gains were significant in reducing local pain for up to three days. Considerable  relief came from treating infraspinatus,&nbsp;subscapularis, pectoralis major,  pectoralis minor, levator scapula and serratus anterior. Unfortunately, the  contractility and spastic quality of the latissimus ultimately did not reduce.  The patient subsequently underwent bilateral  divisions of<strong> </strong>the thoracodorsal  nerves that innervate the latissimus muscle. This procedure was successful and  the constant pulling sensation diminished.</p>
    <p class="TitleUnderlined">      Outcomes and  follow-up</p>
    <p class="textInfoStyle">360 NMT referred this patient to a functional  movement trainer for advanced dynamic stabilization and conditioning. Because  of post-exercise soreness, NMT was continued for pain management as the patient  rebuilt her core and shoulder strength. Realistic expectations for the  rehabilitation process timeframe were discussed, as were achievable outcomes.  This case is ongoing.</p>
    <div class="linkBoxWhite"><a href="torso-and-back.php">&lt;-Back to Torso &amp; Back</a></div>
  </div>
  <!-- InstanceEndEditable -->
