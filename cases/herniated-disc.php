...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Herniated Disc</h1>
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/herniated_disc_18.jpg" alt="Herniated Disk" class="right marginL3pc marginB2pc "></span><em>Case example coming soon. </em> </p>
