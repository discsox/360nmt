...
<title>Postural Distortion</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Postural Distortion</h1>
    <!--<p class="TitleUnderlined">Presenting symptoms</p>-->
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/postural_distortion_43.jpg" alt="postural distortion" class="right marginL3pc marginB2pc "></span><em>Case example coming soon. </em></p>
    <!--<p class="TitleUnderlined">Evaluation,  clinical reasoning &amp; treatment strategizing</p>-->
    <!--<p class="textInfoStyle">A single leg stance test showed poor balance and ankle stability on the right side compared to the left. NMT examination revealed a significant adhesion between the tibialis posterior muscle and the distal/medial soleus muscle, possibly sourcing the biomechanical dysfunction in the ankle joint. We also suspected damage to the three deep compartment muscle tendons within their tendon sheaths as they dog-legged around the medial malleolus.</p>
    <p class="TitleUnderlined"> Treatment</p>
    <p class="textInfoStyle">The following lower extremity tissues were treated over the course of six visits: tibialis posterior, flexor digitorum longus, flexor hallucis longus, gastrocnemius, soleus, the Achilles tendon, the three fibulari and the plantar fascia. NMT treatment around the site of the baseball impact/trauma restored normal ankle movement and optimized weight-bearing distribution. Increased extensibility in these muscles also equaled out his leg length, and the heel lift was subsequently deemed redundant.</p>
    <p class="TitleUnderlined">      Outcomes and  Follow-up</p>
    <p class="textInfoStyle">The speed of recovery was quick in this case due to combined chiropractic and physical therapy care. After the initial NMT session, he had less pain and discontinued the use of a brace. Client was able to run without pain after four NMT treatments, and then resumed baseball training. NMT treatment to the adhesions in the tissues in the lower extremity was a valuable component in this collaborative recovery program.</p>-->
