...
<title>Shoulder Impingement Syndromes</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class="center">Shoulder Impingement Syndromes</h1>
      <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/shoulder_impingement_49.jpg" alt="Shoulder Impingement syndrome" class="right marginL3pc marginB2pc "></span><em>Case example coming soon.</em> </p>
