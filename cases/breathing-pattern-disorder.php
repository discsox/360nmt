...
<title>Breathing Pattern Disorder</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
    <h1 class="center">Breathing Pattern Disorder    </h1>
    <p class="textInfoStyle"><span class="roundedCorners right bg360 paddingL3pc paddingB2pc"><img src="../_images/cases/breathing_pattern_3.jpg" alt="abdominal pain" class=" "></span>Functional breathing pattern disorders (BPD), one of the extremes of which is hyperventilation, disturb the biochemistry of the body, often leading to respiratory alkalosis. Breathing disorders are common, especially with women. </p>
    <p class="textInfoStyle">Research shows that BPDs can be responsible for causing, or helping to maintain, a vast range of symptoms including muscular pain (particularly involving the thorax and neck area), inefficient motor control, reduced core stability, tremors, fatigue, feelings of anxiety, sleep disturbances, dysphagia, epigastric pain, IBS, parasthesia, palpitations, dizziness, disturbed vision, and a variety of circulatory symptoms resulting from smooth muscle constriction. These relationships often go undetected if not recognized by trained clinicians. </p>
    <p class="textInfoStyle">BPDs are easily tested for and, with patient cooperation, are generally correctable via a combination of manual therapy and breathing rehabilitation strategies.</p>
    <p class="textInfoStyle"><strong>We recommend <A HREF="http://www.amazon.co.uk/Recognizing-Treating-Breathing-Disorders-Multidisciplinary/dp/0443070539/ref=as_li_tf_cw?&linkCode=waf&tag=wwwleonchaito-21" target="_blank">Dr. Leon Chaitow&rsquo;s book</A> for more information on Breathing Pattern Disorders. </strong></p>
    
    
    <p class="textInfoStyle"><em>Case example coming soon. </em></p>
