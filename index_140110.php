...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentNews">
    <div class="ContentNews left">
      ...
      <div class="left">
        <p class="xmasRed marginLR5pc center marginTB2pc"><strong>Save  15%  on Gift Cards</strong></p>
        <div class="xmasRedBG paddingTB2pc">
          <p class=" center marginTB2pc xmasGreenBG paddingTB2pc marginLR5pc"><a href="https://clients.mindbodyonline.com/ASP/home.asp?studioid=5589" target="_blank">PURCHASE HERE</a></p>
        </div>
        <span class="newsPic"><a href="#" target="_blank" ><strong><img src="_images/xmas_joy.jpg" alt="360NMT Xmas 2013" width="96%" class="left" title="360NMT Xmas 2013" onClick="MM_openBrWindow('_images/xmas_joy.jpg','','width=570,height=287')"></strong></a></span>

        <h1  class="newsTitle marginT10px xmasGreen" ><strong>SEASON's GREETINGS & HAPPY NEW YEAR!</strong></h1>
      </div>
    </div>
  </div>
  <!-- InstanceEndEditable -->
