...
<title>Testimonials - 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      ...
      <p class="textInfoStyle"><span class="roundedCorners right paddingL3pc paddingB2pc"><img src="_images/team1.jpg" alt="logo" ></span>&ldquo;Over the past few years I have seen you for shoulder problems, back issues, neck pain and bursitis in my hips.
You were also there for me when I went through 2 knee replacements.  I want to thank you for keeping me
vertical through all of these injuries.  Also I credit you for making it possible for me to return to the tennis court
which I couldn’t have done without your help.&rdquo;</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;I have had the most success in addressing my running related discomforts through 360 NeuroMuscular Therapy. Not only has the pain subsided, but the results came about extremely quickly—as opposed to more traditional forms of physical therapy that I have done in the past.&rdquo;</p>
      <hr class="Divider200px">
    <p class="textInfoStyle">&ldquo;360 NMT has great depth of knowledge and great hands! They gave me emotional support with my injury, helped me regain my confidence, and were a referral source for a podiatrist and a physical therapist. Without 360, I wouldn&rsquo;t be racing today at this level!&rdquo;</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;I'm a lifetime runner and ran injury free until my mid 30's, when I developed achilles tendonosis and calf issues. I had surgery on my tendon, and have seen other physical therapists and chiropractors, who have joked, &ldquo;Your tissues are like dried buffalo meat,&rdquo; &ldquo;You are job security&rdquo;, and, &ldquo;I don't walk on water.&rdquo; By contrast, within weeks of my first appointment with 360 NMT I could feel a difference. I had a great year and achieved a lifelong goal by running the Mount Washington Road Race.&rdquo;</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;After years of lower back problems and sciatica and thousands of dollars spent on chiropractic and medical care, I have had total relief with 360 NMT. I feel better than I have in 15 years."</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;It is unfortunate that some would misconstrue what 360 does as mere massage. It is nothing short of a total, beneficial realignment of your body in just one hour."</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;I'm 60 but I feel 30 thanks to 360."</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;The magic touch of 360 staff enabled me to get through a twin pregnancy and recover from two ruptured discs. 360&rsquo;s willingness to work with my physical therapist has helped me become an extremely mobile and active mother of three."</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;I&rsquo;ve been a 360 client since 2000, upon the referral of my foot surgeon. The NeuroMuscular Therapy 360 performs on my feet, which are riddled with scar tissue from several surgeries, is the only reason I can walk normally."</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&ldquo;I first came to 360 reactive, because I had an injury. I continue to work with 360 proactively, because it keeps me injury free. Because of 360, I can run 360 miles in 6 weeks and feel good!"</p>
      <hr class="Divider200px">
      <p class="textInfoStyle">&quot;I had been experiencing  significant pain and loss of flexibility in my neck as a result of an injury a  few years ago. After having limited results at more traditional physical  therapy, I was referred to Denise and 360 NMT. The combination of  targeted acupuncture with deep tissue massage has greatly improved both the  pain level and range of motion.&quot; BB</p>
      <hr class="Divider200px">
    </div>
  <!-- InstanceEndEditable -->
