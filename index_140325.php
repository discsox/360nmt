...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentNews">
    <div class="ContentNews left">
      ...
      <div class="left">
        <div class="center marginTB2pc"> Trigger Point Workshop with Amber Davies </div>
        <div class="newsPic"><a href="#" target="_blank" ><img src="_images/news/amberdavis_100.jpg" alt="Amber Davis" class="right" onClick="MM_openBrWindow('_images/news/amberdavis_370.jpg','','width=370,height=503')" title="Amber Davis"></a><a href="#" target="_blank" ><img src="_images/news/trigger_point_therapy_100.jpg" alt="Amber Davis" class="right" onClick="MM_openBrWindow('_images/news/trigger_point_therapy_370.jpg','','width=370,height=478')" title="Amber Davis"></a>
          <div class=" iPhoneSpacer">&nbsp;</div>
        </div>
        <div class="textNews">Join us for a fun afternoon workshop with Amber Davies, author of the <a href="http://r20.rs6.net/tn.jsp?e=001xO-YBkXTEOQZAk0Bt6M740zgwJ4hcU5anG0onRN5EQ_J03SAE-VyGDVkOwy-mGSKKWB0HjJcQoLlpV6GVtkVtVNsGiPTJ5kFcKE07zT-duCH61PE0l5jSQ==" target="_blank"><strong>Trigger Point Therapy Workbook</strong></a>. The 3rd edition is hot-off-the-press! <br>
        </div>
        <div class="center linkBoxWhiteNews "> <a href="https://clients.mindbodyonline.com/ASP/ws.asp?studioid=5589&stype=41&prodid=461" target="_blank">Sunday March 23 <br>
          2:30 pm - 5 pm <br>
          $40 </a></div>
        <div class="clearBoth">&nbsp;</div>
        <div class="textNews center">Registration includes a 7-ball kit and a "how-to" materials.
          Books will be available for sale at a discounted rate.</div>
        <div class="textNews orange" style="text-align:center;color: #E46C0A;">
          Hurry, space is limited!</div>
        <div class="center"> <a href="https://clients.mindbodyonline.com/ASP/ws.asp?studioid=5589&stype=41&prodid=461&sessionChecked=true" target="_blank">REGISTER</a></div>
      </div>
    </div>
  </div>
  <!-- InstanceEndEditable -->
