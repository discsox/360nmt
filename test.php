...
<div id="HeaderContainer">
      ...
      <div id="Navigation">
        <nav><ul>
              <li><a href="whats-wrong.php">What's Wrong?</a> 
                <ul>
                    <li><a href="cases/head-and-neck.php">Head &amp; Neck</a></li>
                      ...
                      <li><a href="cases/other-syndromes.php">Other Syndromes</a></li>
                  </ul>
              </li>
              <li><a href="services.php">Services</a>
                  <ul>
                    <li><a href="360nmt.php">360 NMT<sup>&reg;</sup></a></li>
                      ...
                      <li><a href="pilates.php">Trigger Point Dry Needling</a></li>
              ...
              <li><a href="#">Seminars</a>
                  <ul>
                      ...
                      <li><a href="https://clients.mindbodyonline.com/ASP/home.asp?studioid=5589" target="_blank">Registration</a></li>
                      <li><a href="faq-seminars.php">FAQ</a></li>
                  </ul>
              </li>
...
<div id="ContentFull">
    <p class="teamName">Problem-solving Massage Therapy </p>
    <p class="teamCert">CNMT, CMTPT </p>
    <p class="teamTxt teamDetailPic"><img src="_images/team/katie.jpg" alt="Katie Adams">Katie Adams is a medically recognized leader in soft-tissue pain management. She founded 360 NeuroMuscular Therapy in 2004 to provide adjunct neuromuscular treatment for hospital medical practices, pain-focused physicians, physical therapists, chiropractors, and dentists. In 2006, she joined forces with colleague and now business partner Stewart Wild. Together, they have built the expertise and professional reputation of 360 NMT® as the only practice in Greater Boston exclusively focused on rehabilitation of soft-tissue dysfunction associated with medically diagnosed injury and myofascial pain <A HREF="javascript:alert('Your screen resolution is '+document.documentElement.clientWidth+'x'+screen.height);">Click for your window size</A>
.</p>
    <p class="MainTxt">&nbsp;</p>
    <p class="MainTxt"><!--<A HREF="javascript:alert('Your screen resolution is '+document.documentElement.clientWidth+'x'+screen.height);">what is it</A>--></p>
    <div class="video-container">
        <!--<iframe src="http://www.youtube.com/embed/Qu9cTeLhxFY" frameborder="0" width="560" height="100%"></iframe>-->
        <iframe width="560" height="315" src="//www.youtube.com/embed/Qu9cTeLhxFY" frameborder="0" allowfullscreen></iframe>
    </div>
    <p class="teamTxt"> Katie holds a BA from Ithaca College and achieved national NMT certification in 1996 after graduating from the Massage Institute of New England. She specializes in manual trigger point deactivation and continues to train with physician-led organizations whose seminal research into pathophysiology of myofascial pain is revolutionizing the field. She is an active member of the American Massage Therapy Association, the National Association of Trigger Point Therapists, and the International Myopain Society.      </p>
    <p class="MainTxt">&nbsp;</p>
    <p class="teamTxt">Katie is a regular speaker at medical conferences, including for the last three years, the New England Baptist Shoulder & Sports Symposium. She is also on the faculty of Myopain Seminars in Bethesda, MD, a post-graduate, professional education program that teaches evidence-informed treatment techniques and management of myofascial pain.      </p>
    <p class="MainTxt">&nbsp;</p>
    <p class="MainTxt">A dancer at heart, Katie is passionate about helping restore pain-free movement for her patients.      </p>
    <p class="MainTxt">&nbsp;</p>
...
<p class="marginT6px"><a href="#" id="Location" >Location</a></p>
  ...
  </div><!-- #EndLibraryItem --><div id="CopyRight">&copy; 2004 - 2013, 360 NMT, Inc. All Rights Reserved | <a href="privacy.php">Privacy Statement</a> | <a href="terms.php">Terms of Service</a></div>
