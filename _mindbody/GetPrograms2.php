...
// Configuration	
	...
	$_MBService = "AppointmentService";
	$_MBRequest = "GetBookableItems";
	$_useDates = true;
	$otherservice = null;
	$otherservicevalue = null;
	$otherservice2 = null;
	$otherservicevalue2 = null;
  ...
  <div id="Left60percent">
    <div class="borderRight">
	  ...
	  <div class="marginLR10pc">
        <form action="GetPrograms2.php" method="post" class="formBackground radius8">
