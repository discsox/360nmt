...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">Myopain Seminars</h1>
    <h2 class="textInfoStyle"><strong>MANUAL TRIGGER POINT THERAPY (MTT) </strong></h2>
    <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/seminars_blue.jpg" alt="Seminars" class="right"></span><a href="http://myopainseminars.com/" target="_blank"><strong>Myopain Seminars</strong></a> were originally developed by Robert Gerwin, MD and Jan Dommerholt DPT of Bethesda, MD and named in honor of Janet G. Travell, MD. Dommerholt and Gerwin are leaders in the field of myofascial pain management and Myopain Seminars courses are considered the seminal Myofascial Trigger Point Therapy training program in the United States.</p>
    <p class="textInfoStyle">Stewart Wild, CMTPT, CNMT was the first massage therapist in the U.S. to certify with Myopain Seminars and designed the current manual program for immediate clinical application. Stewart Wild and Katie Adams are both on the Myopain Seminars faculty and regularly employ these techniques the 360 NeuroMuscular Therapy clinic in Needham, Massachusetts.</p>
    <p class="textInfoStyle"> Manual Trigger Point Therapy (MTT) is a 100 CE-Hour certification program that emphasizes precise palpation and deactivation of trigger points. Three, 3-day courses cover 180 muscles of the body. Theory material is online and includes quizzes and lectures on trigger point research, pain sciences, chronic pain conditions.The program is intended to certify manual trigger point therapists to an industry-high standard. </p>
    <p class="marginL5pc"><strong>Requirements for certification: </strong></p>
    <ol class="marginL5pc marginTB0">
      <li> Attendance at all practical components; MTT 1-3.</li>
      <li>Passing all end-of-workshop practical “test outs” on two muscles        </li>
      <li>Passing all course quizzes online        </li>
      <li>Passing a final theory certification online        
        <ul class=" marginTB0">
          <li>A 75 question MCQ theory exam (70% pass mark) </li>
        </ul>
      </li>
    </ol>
    <p>&nbsp;</p>
    <p class="textInfoStyle">Graduates of the Manual Trigger Point Therapy achieve Certified Myofascial Trigger Point Therapists (CMTPT) credentials and are eligible to join the National Association of Myofascial Trigger Point Therapists (NAMTPT) as professional members.</p>
    <p class="textInfoStyle">Registration for MTT is via <a href="http://www.myopainseminars.com/seminars/travell/mtt/registration.html" target="_blank"><strong>Myopain Seminars</strong></a>. Access the registration form <a href="http://www.myopainseminars.com/seminars/pdf/regform-travell_mtt-2013.pdf" target="_blank"><strong>here</strong></a>, and fax to 301.654.0333</p>
