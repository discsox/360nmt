...
<!--[if gt IE 8]><!-->
<html class=""><!-- #BeginTemplate "/Templates/main_template.dwt.php" --><!-- DW6 -->
<!--<![endif]-->
<?php 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <!-- #BeginEditable "Content" -->sdfasdf
  <div id="SearchContent"><!-- Google Search Result Snippet Begins -->
  <div id="results_010019495098111598081:h9zib0tjftg"></div>
  <script type="text/javascript">
    var googleSearchIframeName = "results_010019495098111598081:h9zib0tjftg";
    var googleSearchFormName = "searchbox_010019495098111598081:h9zib0tjftg";
