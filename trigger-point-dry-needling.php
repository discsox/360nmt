...
<title>Trigger Point Dry Needling 360 Neuromuscular Therapy</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">Trigger Point Dry Needling</h1>
    <div class="videoWrap">
      <div class="video-container">
        <iframe width="560" height="315" src="//www.youtube.com/embed/RkxiQNTaWyk" frameborder="0" allowfullscreen ></iframe>
      </div>
    </div>
    ...
    <p class="textInfoStyle"> Benefits  of Dry Needling include reduction of local pain and muscle spasticity,  increased joint range-of-motion, improved muscle activation patterns, reduction  in centrally sensitized, widespread pain. It is essential to elicit local a  twitch response (spinal cord reflex) as the first step in breaking a myofascial  pain cycle. Most patients do not feel the insertion of the needles, but the  twitch responses from muscles can cause a very brief, sometimes painful  response. This is a therapeutic and a desirable reaction.</p>
    <p class="textInfoStyle">Various methods of mechanical stimulation of the  needle are used once the point has been identified. The idea is to create a  small (but patient tolerable) pocket of damage to the fibers that contain the  trigger point. This may be followed by some compression and local myofascial  stretching. Some post-treatment bruising and soreness may be noticed. This  post-treatment inflammatory response and subsequent tissue repair may itself  account for the efficacy of the treatment.    </p>
    <h2> Trigger Points</h2>
    <p class="textInfoStyle">Trigger points form for many reasons -- overload,  overuse, misuse, disuse and abuse. They can be &lsquo;active&rsquo; (spontaneously causing  pain) or &lsquo;latent&rsquo; (not actively causing pain but contributing to dysfunction). Both  active and latent trigger points can refer pain to distant parts of the body,  far from their actual location.</p>
    <p class="textInfoStyle"> Pain derived from muscular trigger points is said to  be involved in 85% of all chronic conditions. Despite being so very common,  more research is still needed on basic questions such as what trigger points  are and why they occur.</p>
    <p class="textInfoStyle"> Vibration Sono-Elastography (VSE) ultrasound images  show trigger points as tiny, dense, space-occupying, elliptically shaped  contractures found in the mid-fiber region of a muscle. These contractures can  occlude blood vessels, cause pain and just take up space. </p>
    <p class="textInfoStyle">Trigger points have also been biopsied using an  in-vitro sampling technique. Results found that the trigger point environment  contains many pain causing, contractile and acidic chemicals.  </p>
  </div>
  <!-- InstanceEndEditable -->
