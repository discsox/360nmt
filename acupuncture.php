...
<title>Acupuncture 360 Neuromuscular Therapy</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center"><!--<strong>針灸</strong>--> Acupuncture</h1>
    <p class="textInfoStyle"></p>
    <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/acupuncture.jpg" alt="acupuncture" class="right"></span>Acupuncture is a gentle, safe and powerful form of
traditional Chinese medicine which involves the
insertion of fine, sterile needles in specific points in
      the body. This ancient art of healing is used to
      unblock and stimulate the flow of energy within the
    body, returning it to a state of balance and health.</p>
    <p class="textInfoStyle">At 360 NMT, acupuncture is very valuable for
      reducing pain in patients that are initially too sensitive for
      manual hands-on therapy.  It can also help reduce systemic issues that arise from experiencing prolonged pain, such as IBS, anxiety and insomnia.      </p>
    <p class="textInfoStyle">Acupuncture is a great natural alternative for patients
      who may have had negative reactions to (or are trying to avoid) pharmaceuticals for pain. Many theories try to explain how acupuncture works, citing its various influences on the connective tissue, muscles, circulation, nervous and endocrine system. Receiving acupuncture in conjunction with neuromuscular therapy yields long lasting results for optimal musculoskeletal health.</p>
    <!--<div id="Left50-50">
      <p class=" marginTB0"><strong>Chronic issues that respond well to  Acupuncture and Chinese Herbal Medicine:</strong> </p>
      <ul class="marginTB0">
        <li>Migraines/headaches</li>
        <li>Insomnia  and anxiety disorders</li>
        <li>Women&rsquo;s  health issues like PMS, irregular periods, menopausal symtpoms</li>
        <li>Chornic  pain in neck, shoulders and lower back</li>
      </ul>
      <p>&nbsp;</p>
    </div>
    <div id="Rigth50-50">
    <p class=" marginTB0"><strong>Acute conditions that Chinese  Medicine treats very well include:</strong></p>
    <ul class=" marginTB0">
      <li>Sprains,  muscles spasms, bruises</li>
      <li>Bell&rsquo;s  Palsy</li>
      <li>Common  Cold</li>
    </ul>
      <p class="marginTB0">&nbsp;</p>
      <p class="marginTB0"><strong>Other areas of treatment that  Acupuncture can support:</strong></p>
      <ul class="marginTB0">
        <li>Fertility  – to promote regular cycles, ovulation, fertilization, assist IVF</li>
        <li>Cancer recovery - to help the body recover from  chemotherapy or radiation, reduce&nbsp;nausea, improve appetite, alleviate  depression    <br>
          <br>
        </li>
      </ul>
    </div>-->
    <div class="clearBoth">&nbsp;&nbsp;</div>
    <p class=" KronaOne center Txt12px orange "><strong>Acupuncture and Traditional Chinese Medicine is  effective for treating Chronic, Acute and Other conditions:</strong></p>
  </div>
  <div class="center" id="Thirds1">
    <div class="linkBoxWhite2">
      <p class="Txt13px paddingB2pc"><strong>Chronic Issues...</strong></p>
      <p class="gray">Migraines<br>
        Insomnia<br>
        Anxiety<br>
        Depression<br>
        Menopause<br>
  ...
  <div class="center" id="Thirds2">
    <div class="linkBoxWhite2">
      <p class="Txt13px paddingB2pc"><strong>Acute Conditons...</strong></p>
      <p class="gray">Muscle spasms<br>
        Sprains<br>
        Bell's  Palsy<br>
      Common  cold <br>
      Digestive issues <br>
  ...
  <div class="center" id="Thirds3">
    <div class="linkBoxWhite2">
      <p class="Txt13px paddingB2pc"><strong>Other areas...</strong></p>
      <p class="gray">
        Fertility<br>Cancer  pain &amp; recovery<br>
  ...
  <div class="clearBoth">&nbsp;</div>
    <div class=" marginT10px center">
      <p>For more information &amp; research about  acupuncture click <a href="resources.php"><strong>here</strong></a></p>
      <p>Follow &nbsp;Fannie Koa's Pinterest board on  <strong><a href="http://pinterest.com/tsinoy/acupuncture-chinese-herbs/" target="_blank">Acupuncture and Chinese Herbs</a></strong><a href="http://pinterest.com/tsinoy/acupuncture-chinese-herbs/" target="_blank"></a></p>
    </div>
  <!-- InstanceEndEditable -->
