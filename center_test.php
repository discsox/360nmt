...
<div id="Slider"><!--<img src="images/slide_bg.jpg" alt="bg" style="float:left;">-->
  <div id="content-slider-1" class="royalSlider contentSlider rsDefault block"> 
      <!--<div style="/* [disabled]position:relative; */">-->
      <div class=""> <img class="rsImg" src="_images/broken_link.jpg" data-rsw="400" data-rsh="330">
        <div class="centered">
<h3>Trigger points are often the missing link of pain puzzles</h3>
        ...
        <span class="LearnMore hideInMobile">Learn More ></span>
      </div>
      <div> <img class="rsImg" src="_images/woman.jpg" data-rsw="400" data-rsh="330">
        <div class="centerIt">
        <h3>Pain is isolating</h3>
        <p class="textSlidshow  hideInMobile">Pain can affect your whole life. Prolonged pain changes the nervous system. 360 NMT treatments combine evidence-informed research and proven manual techniques to interrupt pain pathways and restore function. We want you to play in the places that you used to ache.
</p>
        </div>
      ...
      <div> <img class="rsImg" src="_images/pen_paper.jpg" data-rsw="400" data-rsh="330">
        <h3><br>
          Our approach is comprehensive </h3>
        <span class="LearnMore hideInMobile">Learn More ></span> </div>
      <div> <img class="rsImg" src="_images/socker.jpg" data-rsw="400" data-rsh="330">
        <h3>Treating trigger points expedites recovery </h3>
        <span class="LearnMore hideInMobile">Learn More ></span> </div>
      <div> <img class="rsImg" src="_images/x_ray.jpg" data-rsw="400" data-rsh="330">
        <h3>Muscle pain can’t be seen on x-rays, but it’s real</h3>
        <span class="LearnMore hideInMobile">Learn More ></span> </div>
    </div>
</div>
