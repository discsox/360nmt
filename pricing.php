...
<title>360 Neuromuscular Therapy Pricing</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
  <h1 class="center">360 NMT<sup>&reg;</sup> Pricing</h1>
  <div class="" id="GenText" >
    <table  border="1" cellpadding="0" cellspacing="0" id="pricing1" class="">
  <tr>
    <th width="25%" rowspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="tableValues"><img src="_images/360-logo_web_8small.png" alt="Logo" ></th>
    <td width="25%" height="55" valign="middle"  bgcolor="#E4A54E" class="tableTitle">Resident NMT</td>
    <td width="25%" valign="middle" bgcolor="#ec7519" class="tableTitle" w>360 NMT<sup>&reg;</sup></td>
    <td width="25%" valign="middle" bgcolor="#B51385" class="tableTitle" w>Corrective
      Movement</td>
    </tr> 
  <tr>
    <td height="80" valign="top" bgcolor="#E4A54E" class="tableText">Massage Therapists doing intensive post-graduate studies at 360 NMT</td>
    <td valign="top" bgcolor="#ec7519" class="tableText">360's signature NMT treatment with our Advanced therapists </td>
    <td valign="top" bgcolor="#B51385" class="tableText">Biomechanical Assessment and Intervention</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">30&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$50</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$70</td>
  ...
  <tr>
    ...
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$115</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">60&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$85</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$110</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$150</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">75&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$105</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$130</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">90&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$120</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$155</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">120&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$155</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$195</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
</table>
    <table  border="1" cellpadding="0" cellspacing="0" id="pricing2" class="">
  <tr>
    <th width="30%" rowspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="hideInDesktop tableValues"><img src="_images/360-logo_web_8small.png" alt="Logo" ></th>
    <td width="30%" height="55"  bgcolor="#E4A54E" class="tableTitle">Trigger&nbsp;Point 
      Dry&nbsp;Needling</td>
    <td width="30%" valign="middle" bgcolor="#ec7519" class="tableTitle" w>Acupuncture</td>
    </tr> 
  <tr>
    <td height="80" valign="top" bgcolor="#E4A54E" class="tableText">Trigger point deactivation only using a solid filament needle. </td>
    <td width="30%" valign="top" bgcolor="#ec7519" class="tableText">Comprehensive acupuncture sessions with Traditional Chinese Medicine</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues hideInDesktop">30&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues hideInDesktop">45&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$95</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues hideInDesktop">60&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$120-$150</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues">$90</td>
    </tr>
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues hideInDesktop">75&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues ">$145</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
  <tr>
  ...
  <tr>
    <td align="center" bgcolor="#FFFFFF" class="tableValues hideInDesktop">120&nbsp;MIN</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
    </tr>
</table>
  ...
  <p class="MainTxt">Flexible Spending Accounts (FSAs)
    Massage treatments for pain management, injuries, illnesses, and stress related conditions are eligible for FSA pre-tax spending. 360 NMT recommends asking for a prescription from your physician. Although not always necessary for FSA approval, a prescription ensures that your treatment will be considered therapeutic and medically necessary. 360 NMT will provide receipts necessary for FSA submission.</p>
