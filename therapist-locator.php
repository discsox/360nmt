...
<title>360 Neuromuscular Therapy Therapist Locator</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div class="center" id="ContentFull">
    <h1>Therapist Locator</h1>
    <div class="tagline">360 NMT often receives requests to help locate  <strong>trigger point</strong> and <strong>neuromuscular therapists</strong> in other parts of the country. We  are continuing to build a vital network of excellent manual therapy colleagues  who specialize in myofascial pain treatment. Please <strong><a href="contact-us.php">contact  us</a></strong>&nbsp;if you would like more information or help finding a  referral in your&nbsp;area.    </div>
  </div>
    ...
    <div class="AccordionWrap">
      <div class="accordion"> 
        ...
        <header class="accordionTopRadius">
          ...
          <div class="AccTitleLarge">Florida</div>
        </header>
        ...
        <section class="content">
          <ul>
            <li>
              <p><strong>Adnan  Sammour, MD</strong><br>
                2227  59th Street West<br>
                Bradenton, FL 34209<br>
              Phone: 941.795.5922</p>
            </li>
            <li>
              <p><strong>Rob  Stanborough, DPT</strong><br>
1  University Blvd<br>
St.  Augustine, FL 32086<br>
Phone: (904)  829-3411<br>
<a href="http://www.firstcoastrehab.com">firstcoastrehab.com </a></p>
            </li>
          </ul>
          <div class="clearBoth"></div>
        </section>
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleLarge">Georgia</div>
        </header>
        ...
        <section class="content">
          <ul>
            <li>
              <p><strong><span class="noWrap">Amanda   Blackmon DPT</span></strong><br>
One  on One PT<br>
3300  Northeast Expwy<br>
Building  8, Suite C<br>
Atlanta, GA 30341<br>
Phone: 770.500.3848 <br>
<a href="http://onetherapy.com/pt/">onetherapy.com</a></p>
            </li>
            <li>
              <p><strong>Blair  Green MPT</strong><br>
One  on One PT<br>
3300  Northeast Expwy<br>
Building  8, Suite C<br>
Atlanta, GA 30341<br>
...
<a href="http://onetherapy.com/pt/">onetherapy.com</a></p>
            ...
            <li>
              <p><strong>Savas  Koutsantonis, DPT</strong><br>
                One  on One PT<br>
                3300  Northeast Expwy<br>
                Building  8, Suite C<br>
                Atlanta, GA 30341<br>
                Phone: 770.500.3848<br>
                <a href="http://onetherapy.com/pt/">onetherapy.com</a><br>
                <br>
              </p>
            </li>
            <li> 
              <p><strong>Karen  Warren, MPT</strong><br>
                One  on One PT<br>
                3300  Northeast Expwy<br>
                Building  8, Suite C<br>
                Atlanta, GA 30341<br>
  ...
  <a href="http://onetherapy.com/pt/">onetherapy.com</a></p>
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleLarge">Illinois</div>
        </header>
        ...
        <section class="content">
          <ul>
            <li>
              <p><strong>Paul  Thomas,  DPT</strong><br>
                Roscoe Village<br>
                1746  W. Addison<br>
                Chicago,  IL 60613<br>
                Phone: 773-770-2000</p>
            </li>
            <li>
              <p><strong>Mary Biancalana, CMTPT</strong><br>
                MYO Pain Relief Centers<br>
                4512 N Drake Ave<br>
                Chicago, IL  60625<br>
                Phone: 773-770-2000<br>
              <a href="http://www.myopain.com/">myopain.com              </a></p>
            </li>
          </ul>
          <div class="clearBoth"></div>
        </section>
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleLarge">Maine</div>
        </header>
        ...
        <section class="content">
          <ul>
            <li class="longAddress">
              <p><strong>Carolyn  Ehringhaus, CNMT,<br>
CMTPT</strong><br>
                Body  Tuning Massage &amp;<br> 
                Neuromuscular Therapy<br>
                222  St. John St., Suite 242<br>
                Portland, ME &nbsp;04102 <br>
              Phone: (207)  899 – 8142<br>
              <a href="http://bodytuningmassage.com/" target="_blank">bodytuningmassage.com</a></p>
            </li>
            <li>
              <p><strong>Jean Hardy LMT, CNMT</strong><br>
Robertson Chiropractic Wellness Ctr.<br>
                326 Belmont Ave., Rt. 3<br>
Phone: 207 338 5850<br>
                Belfast, Maine 04915            </p>
            </li>
          </ul>
          <div class="clearBoth"></div>
        </section>
...
Phone:  301-656-0220<br>
<a href="http://www.painpoints.com" target="_blank">painpoints.com</a></p>
            </li>
            <li>
              <p><strong>Michelle Layton, DPT</strong><br> 
...
(413) 253-9777 </p>
            ...
            <li class="longAddress">
              <p><strong>Erika  Bourne, RN, CMTPT</strong><br>
Myofascial  Pain Treatment Ctr.<br>
204  Arlington Street, Ste 1<br>
Watertown, MA 02472<br>
Phone: 781-894-9430 <br>
<a href="http://www.myofascialpaintreatment.com/">myofascialpaintreatment.com</a></p>
            </li>
            <li class="longAddress">
              <p><strong>Tom Kleinman, CNMT, ART</strong><br>
                Great Barrington, MA 01230<br>
                Phone: 413-717-1612<br>
              </p>
            </li>
          </ul>
          <div class="clearBoth"></div>
      ...
      <div class="accordion"> 
        ...
        <section class="content">
          <ul>
            <li class="longAddress">
              <p><strong>Craig  Reinstein, MS, PT </strong><br>
Advanced  Care PT,<br>
Aquatic, &amp; Fitness Center<br>
924 Main Street<br>
Niagara  Falls, NY 14301 <br>
Office:  (716) 282-2888<br>
<a href="http://advancedcarephysicaltherapy.com/">advancedcarephysicaltherapy.com</a> </p>
            </li>
          </ul>
          <div class="clearBoth"></div>
        </section>
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleLarge">North Carolina</div>
        </header>
        ...
        <section class="content">
          <ul>
            <li class="longAddress">
              <p><strong>Appalachian PT</strong><br>
              211-L Central Park Ave.<br>
              Pinehurst, NC 28374<br>
              Phone: 910-215-0541<br>
              <a href="http://aptfc.com/">aptfc.com</a> </p>
            </li>
            <li> 
              <p><strong>Todd George, LAc, OM, CMPT</strong><br>
                Charlotte Acupuncture <br>
                & Wellness Center<br>
                1217 Harding Place<br>
  ...
  <a href="http://www.charlotteacupuncture.com/">CharlotteAcupuncture.com</a></p>
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleLarge">Texas</div>
        </header>
        ...
        <section class="content">
          <ul>
            <li class="longAddress">
              <p><strong>Anne H. Campbell, PT, OCS, CMTPT</strong><br>
              Access Rehab Clinic &amp;<br>
              Fitness Center<br>
              1501 College Park Dr.<br>
              Ste 109<br>
              The Woodlands, TX 77384<br>
              Phone: 936-273-1095<br>
              <a href="http://accessrehab.org/">accessrehab.org</a> </p>
            </li>
          </ul>
          <div class="clearBoth"></div>
        </section>
      ...
      <div class="accordion"> 
        <!-- Trigger -->
        <header class="accbottom">
          <div class="AccTitleLarge">Virginia</div>
          <div class="indicator" >&nbsp;</div>
        </header>
        ...
        <section class="content accordionBottomRadius">
          <ul>
            <li>
          <p><strong>Tracey  Adler, DPT</strong><br>
            Orthopedic  PT, Inc.<br>
            2000  Bremo Rd. Ste 202<br>
            Richmond, VA 23226<br>
            Phone: 804-285-0148<br>
            <a href="http://www.orthopedicptinc.com/" target="_blank">orthopedicptinc.com</a>          </p>
            </li>
            <li>
              <p><strong>Kevin  Linde, PT</strong><br>
Linde  Physical Therapy <br>
3913  Old Lee Hwy, Ste 31C <br>
Fairfax, VA 22030 <br>
Phone: (703)  877-2224<br>
<a href="http://www.lindept.com/" target="_blank">lindept.com</a> </p>
            </li>
            <li>
              <p><strong>Bill Whiteford,  DPT</strong><br>
                Appalachian  PT<br>
                171  East Springbrook Rd<br>
                Broadway, VA 22815<br>
                Phone:  540-901-9501<br>
                <a href="http://aptfc.com/">aptfc.com</a></p>
            </li>
            <li class="longAddress">
              <p><strong>Ann Wendel, PT, ATC, CMTPT</strong><br>
               109 S. Alfred St.<br>
               Alexandria, VA 22314<br>
               571-527-9192<br>
              <a href="http://www.prana-pt.com/">prana-pt.com</a> </p>
            </li>
          </ul>
          <div class="clearBoth"></div>
        </section>
