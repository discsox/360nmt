...
<title>Lisa Rotondi 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName"><strong>Lisa Rotondi</strong></p>
    <p class="teamCert"> LMT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/lisa_r.jpg" alt="Lisa Gorman" class=""><span class="hide_br"><br>
    </span>Lisa Rotondi is a licensed massage therapist  having received her original training from Cortiva Institute in Watertown, MA.  Prior to 360 NMT, she worked at a busy wellness spa on the North Shore where  she became interested utilizing manual trigger point techniques to solve long  standing pain problems. Lisa will be completing a post-graduate Residency at  360 NMT throughout. She holds additional certifications in Reflexology,  Oncology Massage and Reiki.    </p>
