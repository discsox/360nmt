...
<title>Mike Sirani 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName"><strong>Mike Sirani</strong></p>
    <p class="teamCert"> LMT, CSCS</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/mike.jpg" alt="Lisa Gorman" class=""><span class="hide_br"><br>
    </span></p>
    <p class="teamTxt">Mike Sirani is a Licensed Massage Therapist and Certified  Strength and Conditioning Specialist, through the National Strength and  Conditioning Association. He holds a Bachelor&rsquo;s Degree in Applied Exercise  Science from Springfield College with a concentration in Sports Performance,  where he was also a member of the baseball team. Mike received his initial  neuromuscular therapy training from Cortiva Institute in Watertown, MA.</p>
    <p class="teamTxt">Mike specializes in helping clients with pain and  dysfunction re-learn proper movement patterns through manual therapy,  corrective exercise, and strength training. He enjoys working with people of  all ages and athletic abilities, especially middle and high school students. Prior  to joining 360 NMT, Mike gained a vast amount of experience in the sports  performance and personal training industry by working and interning for several  strength and conditioning facilities, including world-renowned Cressey  Performance.</p>
    <p class="teamTxt">360 NMT Residents are licensed, graduated massage therapists who are selected to fast-track national NMT certification at 360 NeuroMuscular Therapy. They work closely with other staff members to ensure consistent and success treatment outcomes. Resident sessions will combine therapeutic massage with trigger point therapy at special pricing. </p>
    <p class="teamTxt">Provider: <a href="../360nmt.php">Resident</a></p>
  </div>
  <!-- InstanceEndEditable -->
