...
<title>Katie Adams 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Katie Adams</p>
    ...
    <div id="GenText">
      <table  border="1" cellpadding="0" cellspacing="0" id="pricing1" class="fullWidth">
        <tr>
          ...
          <td width="30%" height="55" valign="middle"  bgcolor="#E4A54E" class="tableTitle">Initial Evaluation/<br class="hideInDesktop">Consultation*</td>
        ...
        <tr>
          ...
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$250</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$225</td>
        </tr>
  </table>
    </div>
      <p class="teamTxt">*Initial Evaluations include health history, postural analysis, hands-on therapy, treatment planning and homecare recommendations;</p>
  </div>
  <!-- InstanceEndEditable -->
