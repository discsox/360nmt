...
<title>Timothy Shaw 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName"><strong>Timothy Shaw</strong></p>
    <p class="teamCert"> LMT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/timothy.jpg" alt="Alex McAlice" class=""><span class="hide_br"><br>
    </span>Timothy is a certified orthopedic massage therapist  and holds a B.S. in Kinesiology with advanced study in sports medicine and  athletic training from New England College, Henniker, NH.  He has worked with athletes at every level,  including pro hockey, baseball, golf and Ironman competitors. Tim is also on  staff at the Beth Israel Cheng-Tsui Integrated Health Center, where he treats  patients experiencing acute and chronic musculoskeletal damage and pain. </p>
    <p class="teamTxt"> Tim brings a passion for health and  wellness to 360 NMT where he thrives on the integrative nature of bodywork,  movement and exercise. He resides in Needham along with his wife and young daughter.  An avid hockey player, Tim enjoys working out, cycling, and when the weather  permits....cooking on his grill.&nbsp;</p>
