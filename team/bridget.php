...
<title>Bridget Devine 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Bridget Devine</p>
    <p class="teamCert"> CNMT, CMTPT</p>
    
    <p class="teamTxt"><span class="teamDetailPic"><img src="../_images/team/bridget.jpg" alt="Bridget Devine" class=""></span><span class="hide_br"><br>
    </span>
Bridget Devine is a nationally certified NeuroMuscular Therapist (CNMT) and a Myofascial Trigger Point Therapist (CMTPT). She employs her science-based therapeutic knowledge not only to treat acute and chronic pain, but also to educate clients about musculoskeletal reactions to everyday physical demands. She draws on her experience as a runner and yoga enthusiast to help clients sustain their progress beyond the treatment room by addressing postural and functional issues.</p>
    <p class="teamTxt">Bridget received her training in massage therapy at the Cortiva Institute/Muscular Therapy Institute in Watertown, MA. She holds a bachelor’s degree in studio art from Skidmore College.</p>
    <p class="teamTxt">Outside 360 NMT, Bridget is a volunteer with AccessSportAmerica, helping people with disabilities participate in high-challenge sports. She also enjoys cooking, crafting, and bringing up her young family.</p>
