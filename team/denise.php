...
<title>Denise Devereaux 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Denise Devereaux</p>
    <p class="teamCert"> <strong>Lic. Ac., MAOM, </strong>CNMT</p>
    
    <p class="teamTxt"><span class="teamDetailPic"><img src="../_images/team/denise.jpg" alt="Katie Adams" class=""></span><span class="hide_br"><br>
    </span>Denise is exploring exciting new territory at 360 NMT  by combining neuromuscular therapy with acupuncture. Utilizing her 20 years of experience as a  bodyworker,<strong> </strong>Denise&rsquo;s  NMT sessions are individually customized to include traditional acupuncture  points for overall health and musculoskeletal pain management.</p>
    <p class="teamTxt">Denise began her career in the health care industry in  1993 with her graduation from Stillpoint School of Massage. Before joining 360  NMT, she worked at the world-renowned <a href="http://www.canyonranch.com/lenox" target="new">Canyon Ranch</a>  spa in the Berkshires of western Massachusetts. Denise holds a Master of  Acupuncture and Oriental Medicine from the <a href="http://www.nesa.edu/" target="new">New  England School of Acupuncture (MAOM)</a>, and she is licensed by the  Massachusetts Board of Medicine to practice acupuncture and herbal medicine.  She also is a diplomate with the National Certification Commission for  Acupuncture and Oriental Medicine (NCCAOM).</p>
    <p class="teamTxt">When not at 360 NMT, Denise has her own&nbsp;<a href="https://sites.google.com/site/devereauxacupuncture/home" target="_blank">community acupuncture practice</a><strong>&nbsp;</strong>in  Pittsfield, MA.&nbsp;In her spare time, she may be found hiking, having logged many miles in the Pacific Northwest, the  Colorado Trail, and the Appalachian Trail.   </p>
    <p class="teamTxt">Provider: <a href="../360nmt.php">360 NMT</a>, <a href="http://localhost/360nmt_r/acupuncture.php"> Acupuncture</a></p>
    <p class="teamTxt gray marginLR10pc "><em>Denise’s ability to combine aspects of traditional NMT with Acupuncture will take your treatment to the next level. Incorporating the two modalities is brilliant! Each method brings its own form of relief, but the combination of the two reaches tissue quickly and comprehensively. The results can be felt immediately!
    </em></p>
    <p class="teamTxt gray marginLR10pc"><em>Denise is one of the most compassionate individuals you will ever meet. Consider yourself lucky if you should have the opportunity to be treated by such a knowledgeable professional who can help you immeasurably! 
      <span class="right marginL20">~ KC 2013 </span></em></p>
   <p>&nbsp;</p>
   <div class="left" id="GenText" >
   <h2 class="teamTxt">Pricing</h2>
      <table  border="1" cellpadding="0" cellspacing="0" id="pricing1">
        <tr>
          <th width="50%" rowspan="2" align="center" valign="middle" bgcolor="#FFFFFF" class="tableValues"><img src="../_images/360-logo_web_8small.png" alt="Logo" ></th>
          <td width="50%" height="55" valign="middle"  bgcolor="#E4A54E" class="tableTitle">NMT with 
Acupuncture</td>
        </tr>
        <tr>
          <td height="30" valign="top" bgcolor="#E4A54E" class="tableText">Combo session: NMT with some acupuncture</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">30&nbsp;MIN</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$75</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$125</td>
        </tr>
        <tr>
        ...
        <tr>
          ...
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$200</td>
        </tr>
  </table>
    </div>
