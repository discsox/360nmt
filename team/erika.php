...
<title>Erika Bourne 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName"><strong>Erika Bourne</strong></p>
    <p class="teamCert"> RN, CMTPT </p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/erika.jpg" alt="Alex McAlice" class=""><span class="hide_br"><br>
    </span>Erika has been a  health practitioner in the Boston area for over twenty-eight years. She is a  Registered Nurse and a Board Certified Myofascial Trigger Point Therapist. She  specializes in treating people who are suffering from myofascial pain syndrome,  which is pain derived from active trigger points. Erika brings a unique  synthesis of advanced manual therapy and trigger point dry needling to 360 NMT  with decades of successful patient results.</p>
    <p class="teamTxt"> Erika was inspired  to become a therapist after searching for relief from her own struggle with pain.  She studied the Myotherapy Method with the world renowned Bonnie Prudden in  Lenox, Massachusetts. She then founded the Myofascial Pain Treatment Center in Waltham Mass. in 1986. It is  the longest running clinic of its kind in New England. </p>
