...
<title>Brendan Carney 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Brendan Carney</p>
    <p class="teamCert">Lic. Ac., MAOM, JAS</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/brendan.jpg" alt="Alex McAlice" class=""><span class="hide_br"><br>
    </span>Native  New Englander Brendan Carney has a particular interest in solving pain  conditions using Trigger Point Dry-Needling (TrP DN). He believes that the body  has an innate capacity to heal itself, and when given the right stimulus for  the right problem, it can accomplish amazing turnarounds.  His treatments blend both oriental and  western methods: Japanese acupuncture with myofascial dry-needling.  </p>
    <p class="teamTxt teamDetailPic"> After  graduating from the New England School of Acupuncture in 2008 with a specialty  in Chinese and Japanese Acupuncture and Chinese Herbal Medicine, Brendan went  on to study trigger point release therapy with renowned physiatrist Dr. Joseph  Audette of Harvard Vanguard.  He next completed  an extensive 3-year internship with David Euler, Lic. Ac. and Director of the  Harvard Acupuncture Course for Physicians. Brendan is a current faculty member  at the International Structural Acupuncture Course for Physicians at Harvard  Medical School.  </p>
    <p class="teamTxt teamDetailPic"> Further  advanced training with TrP DN pioneer Jan Dommerholt, DPT of Myopain Seminars ensures  that Brendan is one of the most gifted needling practitioners in the Boston  area. He is well qualified to spread awareness as to the efficacy and safety of  dry needling in the treatment of pain and dysfunction.  </p>
    <p class="teamTxt teamDetailPic"> Brendan  graduated from Colby-Sawyer College in New Hampshire with a degree in Exercise  Science and Business Administration. Throughout college he played basketball  and was named a Div-III Academic All-American in 2002 after successfully  leading his team to their second NCAA appearance.  He went on to become a strength and  conditioning specialist.</p>
    <p class="teamTxt teamDetailPic"> Living  locally with his wife Jennifer, son Baxter, and dog Abby, he enjoys an active  lifestyle including surfing, backcountry skiing, Iyengar yoga, vegetarian  cooking, and fine small batch coffee roasting. Brendan balances working at 360 NMT  with his own private practice in Newton, MA and is on staff at the Osher Center  for Integrative Medicine at Brigham and Women&rsquo;s Hospital. </p>
    <p class="teamTxt teamDetailPic"> Despite  his busy schedule, Brendan is constantly studying to refine the efficacy of  Trigger Point Dry Needling and acupuncture for the relief of pain. He is also  keenly interested in utilizing Dry Needling techniques to optimize sports  performance.</p>
