...
<title>Ean Spangler 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Ean Spangler</p>
    <p class="teamCert"> LMT, CMTPT</p>
    
    <p class="teamTxt"><span class="teamDetailPic"><img src="../_images/team/ean.jpg" alt="Ean Spangler" class=""></span><span class="hide_br"><br>
    </span>
 Ean Spangler is a  Certified Myofascial Trigger Point Therapist (CMTPT), a licensed massage  therapist (LMT), and is currently studying towards an Orthopedic Massage  Therapy certification. Her treatments combine neuromuscular techniques and  trigger point deactivation with gentle yet effective myofascial therapy,  bringing compassion and efficacy to her outcomes. She excels in postural  assessment, and sees postural balance as a key factor in solving cases of  complex myofascial and chronic pain. Her other therapeutic interests include a  desire to better understand mind-body integration as it applies to bodywork and  self-treatment, and how meditation, breathwork and movement can be used as  therapeutic tools to facilitate a person's innate healing potential. Ean incorporates  passive and active stretching into her sessions and also emphasizes patient  education as part of her comprehensive treatment plans.</p>
    <p class="teamTxt">Ean is a graduate of  the Bancroft School of Massage Therapy in Worcester, MA, and has taken 150  hours of vinyasa yoga teacher training at Eyes of the World Yoga Center in  Providence, RI. She has also practiced aikido, a Japanese martial art; studied  Buddhist meditation; and enjoys hiking, dancing, and playing the accordion.</p>
    <p class="teamTxt">Outside of 360 NMT,  she also works as an illustrator/designer and stop-motion animator (<a href="http://www.spanglerstudios.com" target="_blank">www.spanglerstudios.com</a>). She earned  her Bachelor of Fine Arts degree in film and animation from Rhode Island School  of Design.</p>
    <p class="teamTxt">Provider: <a href="../360nmt.php">360 NMT</a>  </p>
