...
<title>Peter Stone 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Peter Stone</p>
    <p class="teamCert"> Corrective Movement</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/peter.jpg" alt="Peter Stone" class=""><span class="hide_br"><br>
    </span><strong>Peter Stone, PT</strong> is collaborating with 360 NMT to develop a <strong>Corrective  Movement Intervention (CMI)</strong> program within our neuromuscular paradigm. Drawing  upon his thirty-eight years of clinical experience, he has created his own functional  assessment protocol that can quickly identify poor movement patterns and  biomechanical imbalances that may perpetuate pain and inhibit response to  neuromuscular treatment. </p>
    <p class="teamTxt">CMI sessions can also be  used proactively for injury prevention. Many 360 NMT clients consult with Peter  when they begin training for competitive activities or seasonal sports. Most  soft-tissue injuries can be avoided with specific corrective activities, regular  NMT treatment and a strong core foundation. </p>
    <p class="teamTxt">The CMI program provides  a cohesive, time-saving and integrative patient care experience at 360 NMT. If  muscle pain is driven by a strength or flexibility imbalance, Peter&rsquo;s movement  screen will find it. He will communicate his findings with 360 therapists,  recommend which muscles to target treatment, and suggest three or four  stretches and movements to reinforce the NMT. The results are lasting.</p>
    <p class="teamTxt"><strong>Corrective Movement Intervention sessions will:</strong></p>
    <ul class="marginL5pc marginTB0">
      ...
      <li>Make appropriate  referrals to other healthcare providers if movement screen reveals joint or  nerve involvement</li>
    </ul>
    <p class="teamTxt">Peter Stone graduated from the  University of Pennsylvania in 1976 and is the founder of Prescription  Orthopedic and Sports Therapy, Inc. (P.O.S.T.). He has been involved with  sports medicine research and physical therapist training throughout his  career.  Passionate about patient  education, Peter&rsquo;s collaboration with 360 NMT will help fortify lifelong  neuromuscular health.  </p>
  </div>
  <!-- InstanceEndEditable -->
