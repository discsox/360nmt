...
<title>Sarah Ernst-Edwards 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Sarah Ernst-Edwards</p>
    <p class="teamCert"> CNMT, CMTPT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/sarah.jpg" alt="Sarah Ernst-Edwards" class=""><span class="hide_br"><br>
    </span>
Sarah Ernst-Edwards is national certified as both a NeuroMuscular Therapist (CNMT) and a Myofascial Trigger Point Therapist (CMTPT). Her areas of concentration at 360 NMT are whiplash and shoulder disorders, repetitive strain injuries, widespread pain conditions such as complex regional pain syndrome (CRPS), and especially prenatal massage.</p>
    <p class="teamTxt">Sarah received her training in massage therapy at the Muscular Therapy Institute (MTI) in Cambridge, now part of the Cortiva Institute, and furthered her knowledge and hands-on skills by working in a busy chiropractic office. Her own recovery from a debilitating back injury, in part through massage, inspired her to help others find relief from pain.</p>
    <p class="teamTxt">A musician who earned her bachelor’s degree in music at Smith College, Sarah especially enjoys treating overuse injuries unique to musicians. She has volunteered at the Pan-Mass Challenge and for the Dana Farber team at the Boston Marathon for many years.</p>
    <p class="teamTxt">
Outside of the treatment room, Sarah enjoys playing piano, cooking and outdoor activities.   </p>
