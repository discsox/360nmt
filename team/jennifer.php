...
<title>Jennifer Parmenter 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Jennifer Parmenter</p>
    <p class="teamCert"> LMT, CMTPT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/jennifer.jpg" alt="Jennifer Parmenter" class=""><span class="hide_br"><br>
    </span>
 Jennifer Parmenter is a Myofascial Trigger Point Therapist (CMTPT) and a licensed massage therapist (LMT). She graduated from the Muscular Therapy Institute in Watertown, MA, now part of the Cortiva Institute.</p>
    <p class="teamTxt"> Jennifer works collaboratively with patients to evaluate and unravel complex pain patterns associated with injuries. Her comprehensive understanding of the effects that physical stress has on the body is derived from her experiences as a trained dancer. Prior to joining 360 NMT, Jennifer worked for over two years in a sports medicine clinic. She enjoys customizing treatments to support and enhance overall health and wellbeing.</p>
    <p class="teamTxt">Jennifer earned her bachelor’s degree in dance from Mills College in California, and was formerly a Doula and Childbirth educator. Outside the treatment room, she enjoys cycling, travel, and studying tai chi.</p>
