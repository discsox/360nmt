...
<title>Lachlan Croteau 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Lachlan Croteau</p>
    <p class="teamCert"> CNMT, CMTPT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/lachlan.jpg" alt="Lachlan Croteau" class=""><span class="hide_br"><br>
    </span>
 Lachlan Croteau is nationally certified in Neuromuscular Therapy (CNMT) and Manual Trigger Point Therapy (CMTPT). In clinical practice, he derives great satisfaction from solving tough and puzzling conditions. These may involve acute or chronic pain. He is particularly skilled in the treatment of tempomandibular joint dysfunction (TMD) using both extra and intra-oral techniques. He also has extensive clinical experience treating pain from whiplash injuries and migraine headache.</p>
    <p class="teamTxt">Lachlan is a graduate of the Cortiva Muscular Therapy Institute in Watertown, MA.  He holds a Bachelors Degree in Communications from Castleton State College in Vermont.</p>
    <p class="teamTxt">Before coming to 360 NMT, he fulfilled his passion for helping animals through his time as a veterinary technician working in an animal shelter. In his leisure time, Lach enjoys biking and taking his dog for hikes.    </p>
