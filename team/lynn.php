...
<title>Lynn Enos 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Lynn Enos</p>
    <p class="teamCert">&nbsp;&nbsp;</p>
    
    <p class="teamTxt"><span class="teamDetailPic"><img src="../_images/team/lynn.jpg" alt="Lynn Enos" class=""></span><span class="hide_br"><br>
    </span>
 Lynn Enos has been involved in physical activity her entire life. She holds a B.S. in Education from the University of Wisconsin-Oshkosh and has over 20 years experience in the fitness industry as an aerobics instructor, personal trainer, and Master Trainer for Resistaball. In 2000, Lynn certified through Stott for mat and taught classes at various gyms on the South Shore. In 2004, she became comprehensively certified through Power Pilates and today she is a Teacher Trainer for Peak Pilates, helping prepare others to become Pilates trainers. Lynn works privately with clients in a quiet, peaceful studio at 360 NMT. She can tailor sessions to assist with injury recovery, prevention, and/or fitness goals.    </p>
    <p class="teamTxt">Provider: <a href="../pilates.php">Pilates</a></p>
  </div>
  <!-- InstanceEndEditable -->
