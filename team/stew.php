...
<title>Stew Wild 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Stew Wild</p>
    <p class="teamCert"> CNMT, CMTPT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/stew.jpg" alt="Stew Wild" class=""><span class="hide_br"><br>
    </span>
 New Zealand-born Stewart Wild is a visionary in the complex field of soft-tissue generated chronic pain. Together with business partner Katie Adams, he has established 360 NeuroMuscular Therapy as an industry leader in problem-solving massage therapy. Combining a busy clinical practice with teaching, Stewart oversees 360 NMT’s professional staff training, clinical outcomes, professional writing, research, and development. He regularly presents seminars on NMT and manual trigger point therapy locally, nationally, and at international conferences. These programs address the alleviation of longstanding pain conditions from the dual paradigms of initial cause and subsequent perpetuating factors.</p>
    <p class="teamTxt">Stewart has studied with the pre-eminent teachers of myofascial pain and dysfunction. In 2009, Stew became the first massage therapist in the U.S. to certify as a Manual Trigger Point Therapist (CMTPT) with Myopain Seminars. He has since developed a 100-hour manual trigger point therapy course and is the program’s senior lecturer. Stew serves as the Vice President of the Certification Board of Myofascial Trigger Point Therapists (CBMTPT), is a regular presenter for the National Association of Myofascial Trigger Point Therapists (NAMTPT), has attended all three Fascia Research Congresses and belongs to the International Myopain Society (IMS).</p>
    <p class="teamTxt">Stewart’s medical background initially began as a hematology laboratory technologist in 1973. He opened his first massage clinic in Auckland, NZ in 1994. He later studied, then taught the ‘St. John version’ of NMT in New Zealand (1998-2003) and, after moving to the United States, taught the ‘American version’ for Judith DeLany, of The NMT Center (2005-2009). He is currently developing a 360 NMT Mastery Certification, encapsulating his many years of clinical experience, study, research, and teaching.</p>
    <p class="teamTxt">
During the ‘80s and ‘90s, Stewart was a successful endurance cyclist, marathon runner, age-group duathlete and triathlete (two Ironmans), representing New Zealand in many overseas competitions. He continues to be an active hiker, skier, and environmentalist, with keen interests in travel, epicure, and the arts.</p>
    <p class="teamTxt">Provider: <a href="../360nmt.php">Master NMT</a></p>
    ...
    <div id="GenText">
      <table  border="1" cellpadding="0" cellspacing="0" id="pricing1" class="fullWidth">
        <tr>
          ...
          <td height="55" valign="middle"  bgcolor="#E4A54E" class="tableTitle">Initial <br class="hideInDesktop">
            Evaluation*</td>
          <td valign="middle" bgcolor="#ec7519" class="tableTitle" w>Follow-up <br class="hideInDesktop">
            Sessions</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">30&nbsp;MIN</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$90</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">45&nbsp;MIN</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
        ...
        <tr>
          ...
          <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$140</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">75&nbsp;MIN**</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$175</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$165</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">90&nbsp;MIN</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$190</td>
        </tr>
        <tr>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">120&nbsp;MIN</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues emptyCell">&nbsp;</td>
          <td align="center" bgcolor="#FFFFFF" class="tableValues">$240</td>
        </tr>
  </table>
    </div>
      <p class="teamTxt">*Initial Evaluations include health history, postural analysis, hands-on therapy, treatment planning and homecare recommendations.<br>
        **preferred  length of treatment time.</p>
  </div>
  <!-- InstanceEndEditable -->
