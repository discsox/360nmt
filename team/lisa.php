...
<title>Lisa Gorman 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName"><strong>Lisa Gorman</strong></p>
    <p class="teamCert"> CMTPT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/lisa.jpg" alt="Lisa Gorman" class=""><span class="hide_br"><br>
    </span>
 Lisa Gorman is a licensed massage therapist and graduated last year from the Cortiva Institute in Watertown, MA. She quickly dove into studying orthopedic massage, achieving an additional 100-hour national certification. Lisa's approach to treating musculoskeletal injuries is informed by her prior experiences working as an environmental and engineering consultant. She holds a Bachelor of Science in Geology from the University of Wisconsin - River Falls and a Master of Science in Sedimentology from the University of Florida.    </p>
