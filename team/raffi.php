...
<title>Raffi Kaivalya 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Raffi Kaivalya</p>
    <p class="teamCert"> LMT</p>
    
    <p class="teamTxt"><span class="teamDetailPic"><img src="../_images/team/raffi.jpg" alt="Raffi Kaivalya" class=""></span><span class="hide_br"><br>
    </span>
 Raffi received his initial muscular therapy training at the Cortiva Institute in Watertown, MA. He quickly certified in orthopedic massage after graduation, and joined the 360 NMT staff while completing his national manual trigger point certification. Raffi's
 holistic approach to bodywork relieves muscular pain within the context of the whole body.</p>
    <p class="teamTxt">He works with his patients to set realistic goals, integrating postural re-education, stretch and general self-care suggestions within the 360 NMT treatment paradigm.</p>
    <p class="teamTxt">Raffi enjoys staying current with NMT/research and new advanced techniques for pelvic stabilization, shoulder dysfunction, TMJ and cervical injuries.  He is also an avid yoga practitioner.</p>
    <p class="teamTxt">When not working with clients or studying, he can most likely be found in the yoga studio, exploring the great outdoors hiking or
 working with the Harvard Women's Swimming and Diving team with his lovely wife Heidi Kaivalya.
</p>
