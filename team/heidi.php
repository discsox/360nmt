...
<title>Heidi Kaivalya 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName"><strong>Heidi Kaivalya</strong></p>
    <p class="teamCert"> LMT</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/heidi.jpg" alt="Heidi Kaivalya" class=""><span class="hide_br"><br>
    </span>
Heidi Kaivalya graduated from the Cortiva Institute in Boston in 2008. She hails from the mid-west and holds a BA in Philosophy from Northern Illinois University. Heidi is the massage therapist for the Harvard Women’s Swimming and Diving team.</p>
    <p class="teamTxt">Prior to joining the 360 NMT staff, Heidi worked at Elements, the Equinox Club and East/West Massage. At the latter she was exposed to many eastern modalities. Her post-graduate courses include orthopedic massage, sports massage and Thai bodywork. She has a Massage Cupping certification and is a certified yoga teacher. She is currently pursuing Manual Trigger Point Therapy certification at 360 NMT.</p>
    <p class="teamTxt">Heidi’s utilization of both east and west philosophies makes her a very well balanced practitioner. She combines a systems-based approach along with clear linear thinking. She has a particular interest in the whole body tension patterns that can lead to myofascial pain.</p>
    <p class="teamTxt">
When not working in the treatment room, Heidi can be found can be found outside soaking up the sunshine, doing yoga and cooking Indian cuisine.</p>
