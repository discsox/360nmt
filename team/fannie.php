...
<title>Fannie Koa 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Fannie Koa</p>
    <p class="teamCert">Lic. Ac., Dipl. O.M., MAOM</p>
    
    <p class="teamTxt"><span class="teamDetailPic"><img src="../_images/team/fannie.jpg" alt="Lynn Enos" class=""></span><span class="hide_br"><br>
    </span></p>
    <p class="teamTxt">Fannie  T. Koa, Lic. Ac., Dipl. O.M., MAOM,&nbsp;is a nationally certified  acupuncturist and herbalist who graduated from <a href="http://nesa.edu/" target="new">New England School  of Acupuncture (NESA)</a>,  the oldest school of Oriental Medicine in the United States. Her education at  NESA involved over 3,000 hours of academic and clinical training. </p>
    <p class="teamTxt"> Fannie  skills in Chinese Medicine bring new and exciting directions in the area of  soft-tissue pain management at <a href="../index.php">360 Neuro Muscular  Therapy</a>.  She has a special interest in food cures and the topical use of Chinese herbs,  as well as the areas of women&rsquo;s health, anxiety disorders and pain  conditions.&nbsp;She is licensed to practice in both Massachusetts and New  Hampshire.</p>
    <p class="teamTxt"> Fannie  is one of the acupuncturists/herbalists on staff at&nbsp;<a href="http://necacupuncture.com/NECA/New_England_Community_Acupuncture.html" target="new">New England  Community Acupuncture</a>&lsquo;s&nbsp;&nbsp;<a href="http://necacupuncture.com/NECA_North_Andover/Home.html">North Andover</a> clinic, where she  sees patients on Tuesdays and Thursdays, from 2-8PM. She also continues to work  part-time at <a href="http://www.tufts.edu" target="new">Tufts University</a> as a  Communications Specialist. </p>
    <p class="teamTxt"> Fannie  lives in the Boston area with her husband and a fur baby (Puppy therapy is  always a negotiable part of treatment).</p>
    <p class="teamTxt">Check/subscribe to  <a href="http://www.fanniekoa.com/blog/" target="_blank">&quot;Fannie's Blog&quot;</a> blog for regular updates on what she&rsquo;s working on and  tidbits related to Chinese medicine.    </p>
    <p class="teamTxt">Provider: <a href="../acupuncture.php">Acupuncture</a></p>
  </div>
  <!-- InstanceEndEditable -->
