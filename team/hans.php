...
<title>Hans 360 Neuromuscular Therapy</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <p class="teamName">Hans</p>
    <p class="teamCert"> Skeleton</p>
    
    <p class="teamTxt teamDetailPic"><img src="../_images/team/hans.jpg" alt="Hans" class=""><span class="hide_br"><br>
    </span>
Hans is originally from Germany. He immigrated to the U.S. and is currently working as the 360 NMT Clinical Skeleton.</p>
    <p class="teamTxt"> Hans loves to show off his bony landmarks during seminars. He’s had his jaw broken three times, and underwent surgery after falling off his perch. Despite this, he still has a continual smile on his face and very good teeth.      </p>
    <p class="teamTxt">Hans has a minor obsession for the work of Dr. Temperance Brennan (star of the TV show “Bones”) and he listens to Wagnerian opera.      </p>
    <p class="teamTxt">In his spare time, he loves to frolic outside and celebrate holidays. Pictures of his adventures can be seen in his very own <a href="https://www.facebook.com/media/set/?set=a.10151724005078586.1073741830.53751713585&type=3" target="_blank">photo album</a> on the 360 NMT Facebook page. </p>
    <p class="teamTxt">Provider: <a href="#">Skeleton</a></p>
