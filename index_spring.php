...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentNews">
    <div class="ContentNews left">
      ...
      <div class="left">
        <div class="center marginTB2pc"> Spring Acupuncture Special<br>
        <span class="textNews">with Fannie Koa, LicAc., Dipl.O.M., MAOM </span></div>
        <div class="newsPic"><a href="#" target="_blank" ><strong><img src="_images/team/fannie_100.jpg" alt="Fannie Koa" class="right" onClick="MM_openBrWindow('_images/team/fannie.jpg','','width=279,height=370')" title="Fannie Koa"></strong></a>
        </div>
        <div class="textNews">
          <p class="orange"><strong>Looking forward to spring but not the seasonal allergies? </strong></p>
          <p>          Acupuncture can not only treat the main allergy symptoms like sneezing, congestion, runny nose, and  itchy eyes, it also addresses the body's underlying imbalances to reduce its hypersensitivity to substances in the environment.<br>
          </p>
        </div>
        <div class="center linkBoxWhiteNews2 "> 
          <p><a href="http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=41&prodid=463" target="_blank"><strong style="font-size:14px">Three sessions | $250* </strong></a></p>
          <p >
            90-min evaluation with treatment<br>
two 50-min follow-up treatments
          <br>
          (*$50 savings!) </p>
        </div>
        <div class="clearBoth">&nbsp;</div>
        <div class="textNews center"></div>
        <div class="center"> <a href=http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=41&prodid=463 target="_blank" class="conditionLink">Purchase Package Here</a></div>
      </div>
    </div>
  </div>
  <!-- InstanceEndEditable -->
