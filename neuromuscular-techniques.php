...
<title>Neuromuscular Techniques</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">Neuromuscular techniques</h1>
    <p class="textInfoStyle"></p>
    <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/stew_katie_ns.jpg" alt="Stew and Katie" class="right"></span>The NeuroMuscular Techniques program consists of six, single day courses. They are organized and instructed in relationship to posture analysis, which is critical for clinical reasoning and successful outcomes. 
</p>
    <p class="textInfoStyle">This unique approach to teaching the traditional NMT techniques is based upon the combined 40+ years of experience that Stewart Wild and Katie Adams have working with clinical NMT application. Each module includes postural assessment, muscle length testing, treatment strategizing, specific hand skills for functionally related muscles and reassessment.      </p>
    <p class="textInfoStyle">Students will learn to solve postural deficiencies, nerve entrapments, trigger point pain and all forms of muscular damage and dysfunction. 360’s NMT courses are all practical - any referenced or related theoretical material and/or quizzes will be available online.</p>
    <p class="textInfoStyle"> <em>Courses can be taken in any order. </em></p>
    <p class="textInfoStyle marginTB0"><strong>NMT CERTIFICATION  CRITERIA</strong></p>
    <ul class="marginL5pc marginTB0">
      <li>Attendance  of NMT 1 - 6 </li>
      <li>Mastery  of online quizzes</li>
      <li>Submission  of a case study: 4 patient treatments that include&rsquo;s postural assessment,  muscle length testing, clinical reasoning, treatment strategizing and  implementation, followed by a reassessment.</li>
    </ul>
    <p>&nbsp;</p>
    <p class="textInfoStyle"><a href="http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=-104" target="_blank"><strong>Register</strong></a></p>
  </div>
  <!-- InstanceEndEditable -->
