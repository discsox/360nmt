...
<title>360 Neuromuscular Therapy Appointments</title>
<?php if(!$production):?> 
...
<div id="HeaderContainer">
      ...
      <div id="Title">
          ...
          <div class="registerIcon"> <a href=" 	http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=-104" target="_blank"><img name="ApointmentLink" src="_images/space.gif" width="44" height="44" alt="Apointment Link"></a> </div>
          ...
          <div class="CalendarIcon"> <a href="https://clients.mindbodyonline.com/ASP/home.asp?studioid=5589" target="_blank" id="MakeAppointment"><img name="ApointmentLink" src="_images/space.gif" width="44" height="44" alt="Apointment Link"></a>
            <div class="day">
              <?=date("l"); ;?>
            </div>
            <div class="DayNumber">
...
<div id="ContentFull">
  <h1 class="center">360 NMT<sup>&reg;</sup> Appointments</h1>
  <div class="" id="GenText" >
    <p class="MainTxt">New Patient Visits and Returning Patient  Appointments for NeuroMuscular Therapy, Dry Needling or Acupuncture can be  scheduled online.</p>
    <p class="MainTxt">&nbsp;</p>
    <p class="MainTxt"> 	<a href="javascript:launchWS('http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=-102&sView=day&sSU=true');">test link</a></p>
    <p class="MainTxt">&nbsp;</p>
    <p class="MainTxt">
      
      Please <u><a href="contact-us.php">contact  us</a></u> if you have any questions about which service is right for you.</p>
    <div class="widgetContainer MainTxt">
      <script type="text/javascript">
  healcode_widget_id = "g25972a2xk";
  healcode_widget_name = "appointments";
  ...
  // Healcode Appointment Widget for 360 NeuroMuscular Therapy, LLC : Appointments
</script>
