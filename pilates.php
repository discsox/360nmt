...
<title>Pilates 360 Neuromuscular Therapy</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">Pilates</h1>
    <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/pilates.jpg" alt="logo" class="right"></span><span class="hide_br"><br>
    </span>Pilates is a movement system designed to strengthen, stretch and balance the body. Classical Pilates is the original work developed by Joseph Pilates with little or no deviation. His original work differs from other methods in that he adheres to an exercise order. The purpose of the order is to consistently recruit muscles in a specific firing pattern which helps to create muscle memory.
    </p>
    <p class="textInfoStyle"><a href="index.php"><strong>360 NMT</strong></a> recommends&nbsp;  private Pilates instruction for patients&nbsp; looking to improve posture,  establish proper movement patterns or increase activity levels as injuries  heal.    </p>
    <h2><span class="teamDetailPicLeft"><img src="_images/lynn_pilates.jpg" alt="logo" class="right"></span><span class="hide_br"><br>
    </span>Benefits&nbsp;include:&nbsp;&nbsp; </h2>
    <div class=" left">
      <ul class="bullets">
        <li>Strengthens&nbsp;core&nbsp;and&nbsp;back</li>
    ...
    <p class="textInfoStyle "><strong>Provider: <a href="team/lynn.php">Lynn Enos</a></strong><a href="team/lynn.php"></a></p>
    <p class="textInfoStyle">Please&nbsp;Schedule&nbsp;with&nbsp;Lynn&nbsp;directly:<br>
      Phone: 781-718-7424<br>
Email: <a href="mailto:Ltenos@yahoo.com">Ltenos@yahoo.com</a></p>
    </div>
  </div>
  <!-- InstanceEndEditable -->
