...
<title>360 Neuromuscular Therapy 360 NMT Services</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">seminars Overview</h1>
    <p class="textInfoStyle"><strong>360 NeuroMuscular Therapy Seminars</strong> provides leading-edge continuing education for manual therapists that specialize in the treatment of soft-tissue pain and dysfunction.</p>
    <h2 class="center">The two core programs of study are:</h2>
    <p class="center Txt16px"><strong><a href="neuromuscular-techniques.php">NeuroMuscular Techniques (NMT)</a></strong></p>
    <p class="center Txt16px"><strong><a href="myopain-seminars.php">Manual Trigger Point Therapy (MTT)</a></strong></p>
    <p>&nbsp;</p>
    <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/faculty.png" alt="Faculty Members" class="right "></span><strong><a href="neuromuscular-techniques.php">NeuroMuscular Techniques (NMT)</a></strong> showcase the original NMT techniques of Raymond Nimmo, Paul St. John, Leon Chaitow, and Judith DeLany. Streamlining these methods from their combined 40+ years of clinical experience, Stewart Wild and Katie Adams have integrated postural and dynamic assessment, clinical reasoning and treatment strategizing into this new, modernized NMT program. Certification can be achieved within six, single day courses (48 CE-Hours) and can be taken in any order</p>
    <p class="textInfoStyle"><strong><a href="myopain-seminars.php">Myopain Seminars: Manual Trigger Point Therapy (MTT)</a></strong> is the most comprehensive training program available in the United States for the study of myofascial trigger points. Jan Dommerholt, DPT and Robert Gerwin, MD developed the original curriculum based upon the work of Janet Travell, MD and continuously integrate current myofascial pain research into the theory lectures. Principal instructor, Stewart Wild CMTPT, CNMT has refined the manual trigger point deactivation techniques for 180 muscles. Certification can be achieved with successful completion of three, 3-day courses, online webinars and exams. Graduates are Certified Myofascial Trigger Point Therapists (CMTPT) eligible to join the National Association of Myofascial Trigger Point Therapists (NAMTPT) as professional members. Courses can be taken in any order (100 CE-Hours).</p>
