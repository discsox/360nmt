...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">360 NMT<sup>&reg;</sup> Services</h1>
    <p class="textInfoStyle"><img src="_images/360_logo_160_8.png" alt="logo" class="right paddingL3pc"></p>
    <p class="textInfoStyle">NeuroMuscular  Therapy (NMT) is advanced, problem solving massage therapy that treats pain and  dysfunction originating from soft tissues of the body. The modality is based upon  four corrective cornerstones: accelerated recovery of muscle damage,  optimization of poor posture, balance within the nervous system, and  deactivation of myofascial trigger points. At the same time, NMT identifies and  modifies the myriad factors that may be perpetuating the problem.</p>
    <p class="textInfoStyle">The 360 NMT® approach is  informed by the latest medical and pain science research. Therapists use very  precise applications of manual compressions and strokes. Each treatment is  tailor-made for the individual. Sessions may include <strong><a href="homecare.php">homecare</a></strong> recommendations for flexibility,  stabilization, balance, stress reduction and nutrition.</p>
    <p class="textInfoStyle">NeuroMuscular Therapy is indicated for many complex and enigmatic pain conditions. It can also be useful for performance enhancement and maintenance, and injury rehabilitation. Often, NeuroMuscular Therapy is the turnkey for cases that have plateaued. By resolving soft tissue dysfunction and reducing trigger point activity, therapeutic strengthening programs become more efficient and effective.</p>
    <p class="textInfoStyle">360 NMT  is also a teaching clinic. The <strong><a href="team.php">Staff</a></strong> regularly present at medical conferences  and teach Advanced on-site continuing education <strong>seminars</strong>. Distinguished by its  ongoing collaborative relationships with the top <strong><a href="recommended-providers.php">healthcare providers</a></strong> in the Greater  Boston area, 360 NMT is the leading neuromuscular training clinic in  Massachusetts.    </p>
    <h2>360  NMT<sup>&reg;</sup> Treatment Options
    <!-- Wrapper -->    </h2> 
