...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentNews">
    <div class="ContentNews left">
      ...
      <div class="left">
        <div class="center marginTB2pc"> 
          <p> Summer Special...</p>
          <p>Play Hard<br>
            <span class="gray"><strong>LISA  HAS YOUR BACK! </strong></span></p>
        </div>
        <div class="newsPic"><strong><img src="_images/beach_300.jpg" alt="Beach" class="right transition" title="Summer of 14"></strong>
        </div>
        <div class="textNews">
          <p><strong><em>We are so lucky to have Lisa Rotondi as our clinical resident! She is fast-tracking a post graduate course of study at 360 NMT, training closely with our senior staff. 
Resident sessions combine therapeutic massage with trigger point therapy. Perfect for keeping your muscles in tip-top shape all summer! </em></strong><br><br>
          </p>
        </div>
        <div class="center linkBoxWhiteNews3 "> 
          <p class="standaout Txt14px">60-Min Massage</p>
          <p class="standaout">&nbsp;</p>
          <p > <strong class="Txt13px">$75 each</strong><span class="standaout"><strong>&nbsp;</strong></span>  <br>
          <a href="https://clients.mindbodyonline.com/ASP/ws.asp?studioid=5589&stype=41&prodid=479" target="_blank"><strong>PURCHASE HERE</strong></a></p>
          <p><br>
<strong class="Txt13px" >packages of 4 @$280</strong> <br>
<a href="https://clients.mindbodyonline.com/ASP/ws.asp?studioid=5589&stype=43&prodid=483" target="_blank"><strong>PURCHASE PACKAGE HERE</strong></a><br>
          </p>
        </div>
        <div class="clearBoth">&nbsp;</div>
        <div class="textNews center"></div>
        <div>
          <p class="newsFooter">Normally $85, this reduced pricing will only  be available for sale through 6/30/14.</p>
          <p class="newsFooter">Sessions must be redeemed by 9/30/14</p>
        </div>
      </div>
    </div>
  </div>
