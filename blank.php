...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="TeamList1" style="height:500px">
  <!--<h2>Problem-solving Massage Therapy </h2>
    <ul>
      <li><a href="#"><img src="images/lisa_35.jpg" alt="Lisa" width="39" height="28" class="absmiddle"><span class="textInfoStyle">Lisa Gorman</span></a><a href="#"><img src="images/r_arrow.png" alt="right arrow" class="teamListArrow" ></a></li>
      <li>asdf</li>
  </ul>-->
  </div>
