...
<title>360 Neuromuscular Therapy Privacy</title>
<!-- InstanceEndEditable -->
<script>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
      <h1 class=" center">Privacy Statement</h1>
      <p class="textInfoStyle">360 NeuroMuscular Therapy (360 NMT<sup>&reg;</sup>), is committed to respecting your  privacy. We've structured our website so that you can visit 360 NMT on the Web  without identifying yourself or revealing any personal information. Once you  choose to provide us personally identifiable information (any information by  which you can be identified), you can be assured that it will only be used to  support your client relationship with 360 NMT. This statement regarding the  privacy of the information you provide online covers five main areas:  Awareness, Choice, Access &amp; Accuracy, Security, and Oversight.</p>
      <p class="TitleUnderlined">Awareness</p>
      <p class="textInfoStyle">360 NMT provides this Online Privacy Statement to make you aware of our  privacy policy and practices and of the choices you can make about the way your  information is collected and used. To make this notice easy to find, we make it  available on our home page and from the bottom of every 360NMT.com webpage.
      </p>
      <p class="TitleUnderlined">What we collect</p>
      <p class="textInfoStyle">360 NMT uses the scheduling software MindBody Online (www.mindbodyonline.com).  Through this program, you can schedule appointments, register for courses and  purchase products or gift cards.  The  types of personal information collected through this program are name, date of  birth, contact and billing information, transaction, and credit card  information.
    </p>
      <p class="TitleUnderlined">How we use it</p>
      <p class="textInfoStyle">360 NMT  only uses your information to help you complete a transaction, to communicate  back to you, and to update you on services and benefits. Credit card numbers  are used only for payment processing and are securely encrypted in the software  system. </p>
      <p class="textInfoStyle">From time to time, we  may send you an email with information, specials or new service offerings we  think would be of particular interest. At a minimum, we will always give you  the opportunity to opt-out of receiving such direct marketing. We will also  follow local requirements, such as allowing you to opt-in before receiving  unsolicited contact, where applicable.    </p>
      <p class="TitleUnderlined">Who we share it with</p>
      <p class="textInfoStyle">360 NMT will not sell, rent, or lease your personally identifiable  information to others. Unless we have your permission or are required by law,  we will only share the personal data you provide online with other 360 NMT  entities and/or business partners who are acting on our behalf to complete the  activities described above.
    </p>
      <p class="TitleUnderlined">Choice</p>
      <p class="textInfoStyle">360 NMT will not use or share your identifiable information provided to  us online in ways unrelated to the ones described above without letting you  know and offering you a choice. As previously stated, we will also provide you  the opportunity to let us know if you do not wish to receive unsolicited direct  marketing materials from us and we will do everything we can to honor such  requests. Your permission is always our first priority. 
    </p>
      <p class="TitleUnderlined">Access &amp; Accuracy</p>
      <p class="textInfoStyle">360 NMT strives to keep your personal information accurate. We will make  every effort to provide you with online access to your data so that you may update  or correct your information. To protect your privacy and security, our software  system takes reasonable steps to verify your identity before granting you  access or enabling you to make corrections. 
    </p>
      <p class="TitleUnderlined">Security</p>
      <p class="textInfoStyle">360 NMT is committed to ensuring the security of your information. To  prevent unauthorized access, maintain data accuracy, and ensure the appropriate  use of information, we have put in place appropriate physical, electronic, and  managerial procedures to safeguard and secure the information we collect  online. The MindBody software uses encryption when capturing or transferring  credit card information. 
    </p>
      <p class="TitleUnderlined">Oversight</p>
      <p class="textInfoStyle">If you have comments 
        or questions about our privacy policy, please send them to this e-mail 
        address: <a href="mailto:info@360nmt.com">info@360nmt.com</a>    </p>
  </div>
  <!-- InstanceEndEditable -->
