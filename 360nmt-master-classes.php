...
<title>360 NMT® Master Classes</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    <h1 class="center">360 NMT<sup>&reg;</sup> Master Classes</h1>
    <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/master_classes.jpg" alt="Master Classes" class="right"></span></p>
        <p class=" center"><strong>COMING SOON    </strong></p>
