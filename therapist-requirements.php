...
<title>360 Neuromuscular Therapy, Therapist Requirements</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
  <h1 class="center">FULL-TIME THERAPISTS</h1>
  <div class="" id="GenText" >
    <p class="MainTxt"><img src="_images/360_logo_160_8.png" alt="logo" class="right">At <em>360  NeuroMuscular Therapy</em>, each team member has the same &ldquo;toolbelt&rdquo; of  techniques, but is given autonomy with his or her patients. The ideal candidate  wants to specialize in the 360 NMT approach to treating soft-tissue pain.</p>
    <p class="MainTxt">&nbsp;</p>
    <h2>Benefits</h2>
    <ul class="bulletsGray">
      <li>Company-sponsored continuing  education</li>
      <li> Healthcare contributions</li>
      <li> Teaching opportunities</li>
      <li> Competitive &amp; innovative  compensation</li>
      <li> Self-care benefits</li>
    </ul>
    <h2>Requirements</h2>
    <ul class="bulletsGray">
      <li>Certificate  from accredited massage therapy program</li>
      <li> 2-3 years work experience        </li>
      <li>NMT or CMTPT certification*        </li>
      <li>Undergraduate/Bachelors Degree        </li>
      <li>AMTA/ABMP membership        </li>
      <li>Good communication skills        </li>
      <li>Team oriented</li>
      <li>Non-competitive </li>
    </ul>
<p class="MainTxt">*if you do not have either  advanced certification, you may fast track employment through 360 NMT&rsquo;s paid  resident training program.</p>
<p class="MainTxt">&nbsp;</p>
<h3 class="MainTxt"><em>To apply, email resume and cover letter to:</em></h3>
<p class="MainTxt paddingL5pc">  Katie Adams<br>
  360 NMT<br>
  35 Highland Circle<br>
  Needham, MA 02494<br>
  <a href="mailto:info@360nmt.com">kadams@360nmt.com</a></p>
<p class="MainTxt paddingL5pc">&nbsp;</p>
<p class="MainTxt "> No Phone Calls Please</p>
<p class="MainTxt">&nbsp;</p>
  </div>
</div>
  <!-- InstanceEndEditable -->
