...
<title>Employment 360 Neuromuscular Therapy</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    ...
    <p class="textInfoStyle"><span class="teamDetailPic "><img src="_images/team_3.jpg" alt="logo" class="right transition"></span>360  NMT<sup>&reg;</sup>  is an advanced massage and manual therapy practice. We value education,  inquisitiveness, communication and compassion. If you are a clinician who wants  a career in the rewarding field of myofascial pain treatment, we would like to  speak with you. Please send inquiries and resumes to <a href="mailto:kadams@360nmt.com"><strong>Katie Adams</strong></a>.    </p>
    <h2>&nbsp;</h2>
    <h2>Job Openings:      </h2>
    <ul class="bullets">
      <li>FULL-TIME  THERAPISTS: <a href="therapist-requirements.php" class="purple">read more -&gt;</a></li>
      <li>RESIDENTS: <a href="resident-requirements.php" class="purple">read more -&gt;</a></li>
    </ul>
  </div>
  <!-- InstanceEndEditable -->
