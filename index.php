    ...
    <div class="ContentNews left">
      ...
      <div class="left">
        <div class="center marginTB2pc"> 
          <p>Nicole Teter-Downin joins our Team!        </p>
        </div>
        <div class="newsPic"><img src="_images/news/nicole.jpg" alt="Nicole Teter-Downin" class="left transition" title="Nicole Teter-Downin">
        </div>
        <div class="textNews ">
          <p class="marginT20px"><em><strong>Nicole  competed in the 2004 Athens and 2008 Beijing Olympics. She still holds the  800-meter American Indoor record. <br>
Massage  therapy is her newest passion, helping athletes of all levels attain optimal  performance and prevent injuries.
          </strong></em></p>
        </div>
        <div class="right linkBoxWhiteNews3 marginR15pc center"> 
          <p class="standaout Txt14px">60-Min Massage</p>
          <p class="standaout">&nbsp;</p>
          <p > <strong class="Txt13px">$50</strong><span class="standaout"><strong></strong></span>  <br>
            <br>
          <a href="http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=41&prodid=492" target="_blank"><strong>PURCHASE HERE</strong></a></p>
          <p><br>
          </p>
        </div>
        ...
        <div>
          <p class="newsFooter">Normally $85, this reduced pricing will only  be available for sale through 9/30/14.</p>
          <p class="newsFooter">Sessions must be redeemed by 12/31/14</p>
        </div>
      </div>
    </div>
  </div>
