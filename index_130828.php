    ...
    <div id="content-slider-1" class="royalSlider contentSlider rsDefault"> 
      ...
      <div> <img class="rsImg" src="_images/egg_shells.jpg" data-rsw="400" data-rsh="330">
        <div class="centerIt">
          ...
          <p class="textSlidshow  hideInMobile">Does poor posture lead to pain? Or, does pain cause poor posture? When movement hurts, 360 NMT assesses postural patterns. Some muscles shorten and tighten, others weaken and lengthen. Regardless of what happened first, we will  help you break out of your postural shell.</p>
        </div>
        <span class="LearnMore hideInMobile">Learn More ></span> </div>
    ...
    <div class="ContentNews left">
      ...
      <div class="left"><span class="newsPic"><a href="#" target="_blank" ><strong><img src="_images/team/fannie_100.jpg" alt="Fannie Koa" class="left" onClick="MM_openBrWindow('_images/team/fannie.jpg','','width=279,height=370')" title="Fannie Koa"></strong></a></span>
        ...
        <p class="newsTitle ">Acupuncture & Chinese Medicine </p>
          <p class="textNews "><strong><a href="http://www.fanniekoa.com/bio" target="new">Fannie Koa</a></strong>, Lic. Ac., Dipl.OM, MAOM, MBA will be joining 360 NMT in September. The addition of Fannie’s skills in Chinese Medicine will provide new and exciting directions in the area of pain management.  See <strong><a href="#">Introductory Specials &amp; Schedule</a></strong> </p>
