...
<script type="text/javascript" src="_scripts/accordion.with.video.js"></script>
    ...
    <div class="AccordionWrap">
      <div class="accordion"> 
        ...
        <section class="content">
          <p class="textInfoStyle">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
          </p>
        </section>
      </div>
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleSmall">Anti-inflammatory Diet</div>
        </header>
        
        <!-- Content Section -->
        <section class="content">
          <p class="textInfoStyle">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        </section>
      </div>
      <div class="accordion"> 
        <!-- Trigger -->
  ...
  <div id="ContentTxt_right"><!-- Wrapper -->
    <div class="AccordionWrap">
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleSmall">Supine Bridges (with jackknife)</div>
        </header>
      ...
      <div class="accordion"> 
        ...
        <header>
          <div class="indicator" >&nbsp;</div>
          <div class="AccTitleSmall">Vleeming’s TrA and Ext Oblique Activation</div>
        </header>
        
        <!-- Content Section -->
        <section class="content">
          <p class="textInfoStyle">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna <a href="#" onClick="MM_openBrWindow('_videos/wall-angels.php','','resizable=yes,width=1020,height=632')">aliqua</a>.</p>
        </section>
      </div>
      <div class="accordion"> 
        <!-- Trigger -->
        ...
        <!-- Content Section -->
        <section class="content accordionBottomRadius">
        <a href="#" onClick="MM_openBrWindow('_videos/wall-angels.php','','resizable=yes,width=1020,height=632')"><img src="_videos/wall_angels.jpg" alt="Wall Angels"></a></section>
      </div>
    </div>
  </div>
  <!-- InstanceEndEditable -->
