...
<title>360 Neuromuscular Terms of Service</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="GenText">
    ...
    <p class="textInfoStyle"><strong>You  are encouraged to use and enjoy the 360nmt.com site, and with your use and  purchase from this site, you agree to these Terms of Service set forth below  and the disclaimers and terms and conditions stated on this site.</strong><br>
    <strong>Disclaimers and Limitation of Liability – 360nmt.com</strong> </p>
      <p class="TitleUnderlined">Disclaimers and Limitation of Liability &#8211; 
        360nmt.com </p>
      <p class="textInfoStyle">The  360nmt.com website is provided on an &quot;AS IS,&quot; &quot;as  available&quot; basis. Neither 360 NeuroMuscular Therapy, nor its affiliates,  subsidiaries, or designees nor each of their respective officers, directors,  employees, agents, third-party content providers, designers, contractors,  distributors, merchants, sponsors, licensors or the like (collectively,  &quot;associates&quot;) warrant that use of the 360nmt.com website will be  uninterrupted or error-free. No oral advice or written information given by 360  NeuroMuscular Therapy, nor its associates, shall create a warranty. You  expressly agree that use of the 360nmt.com site is at your sole risk.</p>
      <p class="textInfoStyle">Prices  and availability are subject to change without notice. Errors will be corrected  where discovered, and 360 NeuroMuscular Therapy reserves the right to revoke  any stated offer and to correct any errors, inaccuracies or omissions including  after an order has been submitted and whether or not the order has been  confirmed and your credit card charged. If your credit card has already been  charged for the purchase and your order is cancelled, 360 NeuroMuscular Therapy  will issue a credit to your credit card account in the amount of the charge. </p>
      <p class="textInfoStyle">We  reserve the right to make changes to the 360nmt.com site and these Terms of  Service at any time by updating this posting. By using the 360nmt.com site, you  agree to be bound by any such revisions and should therefore periodically visit  this page.      </p>
    <p class="TitleUnderlined">Copyrights and Trademarks</p>
      <p class="textInfoStyle"> The 360 NMT<sup>&reg;</sup>mark  on the site is the property of the Company and cannot be licensed to, or, where  required, used with permission by 360 NeuroMuscular Therapy and may not be  reproduced, copied, or manipulated in any manner without the express, written  approval of the trademark owner.</p>
    <p class="textInfoStyle">360  NeuroMuscular Therapy and its suppliers and licensors expressly reserve all  intellectual property rights in all text, programs, products, processes,  technology, content and other materials which appear on this Web site. Access  to this Web site does not confer and shall not be considered as conferring upon  anyone any license under any of 360 NeuroMuscular Therapy's or any third  party's intellectual property rights.      </p>
    <p class="TitleUnderlined">Applicable Law</p>
      <p class="textInfoStyle">The  360nmt.com site is created, operated and controlled by 360 NeuroMuscular  Therapy, LLC in the Commonwealth of Massachusetts, United States of America. As  such, the laws of the State of Massachusetts will govern these Terms of Service  without giving effect to any principles or conflicts of laws. References to 360  NeuroMuscular Therapy, or their affiliates, subsidiaries and designees as  deemed appropriate by 360 NeuroMuscular Therapy. The mailing address for 360  NeuroMuscular Therapy, is 35 Highland Circle, Needham, MA 02494.</p>
      <p class="TitleUnderlined">Links to Third-Party Web Sites</p>
      <p class="textInfoStyle">The  360nmt.com site contains links to other websites. The links are meant to enable  access to publicly available information to those who are allowed to the  360nmt.com site only. 360 NeuroMuscular Therapy makes no representations  whatsoever about any other website which you may access through the 360nmt.com  site.  </p>
  </div>
  <!-- InstanceEndEditable -->
