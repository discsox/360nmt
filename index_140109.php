...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentNews">
    <div class="ContentNews left">
      ...
      <div class="left"><span class="newsPic"><a href="#" target="_blank" ><strong><img src="_images/team/lisa_r_100.jpg" alt="Lisa Rotondi" class="left" onClick="MM_openBrWindow('_images/team/lisa_r.jpg','','width=279,height=370')" title="Fannie Koa"></strong></a></span>
      
          <p class="textNews "><br>
360 NMT welcomes <a href="team/lisa_r.php"><strong>Lisa Rotondi</strong></a> to our  Team.&nbsp;Lisa will be doing a post-graduate residency at 360 NMT while  completing her Manual Trigger Point Certification. <br>
            <br>
        Introductory Sessions with Lisa are at a very <strong>special rate of $50!</strong> <strong><a href="http://clients.mindbodyonline.com/ws.asp?studioid=5589&stype=41&prodid=451" target="_blank"><br>
        Purchase then Book your appointment here!</a></strong> </p>
