...
<title>360 Neuromuscular Therapy, Resident Requirements</title>
<!-- InstanceEndEditable -->
<?php if(!$production):?> 
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
  <h1 class="center">RESIDENTS</h1>
  <div class="" id="GenText" >
    <p class="MainTxt"><img src="_images/360_logo_160_8.png" alt="logo" class="right"><em>360 Residents</em> are Licensed Massage Therapists in the state of Massachusetts and work at 360 NMT while undergoing advanced, post-graduate studies in NMT and Manual Trigger Point Therapy. We generally offer one resident training position per year.</p>
    <p class="MainTxt">&nbsp;</p>
    <h2>Benefits</h2>
    <ul class="bulletsGray">
      <li>Company-sponsored continuing  education</li>
      <li>Mentorship with 360 NMT senior  staff</li>
      <li> Fast Track options to  Full-Time employment</li>
      <li> Competitive compensation</li>
      <li> Self-care benefits
      </li>
    </ul>
    <h2>Requirements</h2>
    <ul class="bulletsGray">
      <li>        Certificate from accredited  massage therapy program </li>
      <li>Current MA State License </li>
      <li> 1 year work experience      </li>
