...
<title>360 Neuromuscular Therapy -  Faculty</title>
<?php 
  //initialize variables  
	  $menuFix = "";
	  //$menuFix = "onClick=\"window.location='#'\"";
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#e46c0a', endColorstr='#f7c397',GradientType=0 ); /* IE6-8 */
  ...
  <div id="ContentFull">
    ...
    <p class="textInfoStyle">360 NMT features the following highly qualified academic staff:<!-- Wrapper -->    </p>
    <div class="AccordionWrap">
      <div class="accordion"> 
        <!-- Trigger -->
        <header class="accordionTopRadius">
          <h3>Stewart Wild, CNMT, CMTPT</h3>
          <div class="indicator" >&nbsp;</div>
        </header>
        
        <!-- Content Section -->
        <section class="content">
          <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/team/stew.jpg" alt="logo" class="right"></span><span class="hide_br">
<br>
</span>New Zealand-born Stewart Wild is a visionary in the complex field of   soft-tissue generated chronic pain. Together with business partner Katie   Adams, he has established 360 NeuroMuscular Therapy as an industry   leader in problem-solving massage therapy. Combining a busy clinical   practice with teaching, Stewart oversees 360 NMT&rsquo;s professional staff   training, clinical outcomes, professional writing, research, and   development. He regularly presents seminars on NMT and manual trigger   point therapy locally, nationally, and at international conferences.   These programs address the alleviation of longstanding pain conditions   from the dual paradigms of initial cause and subsequent perpetuating   factors.</p>
          <p class="textInfoStyle">Stewart has studied with the pre-eminent   teachers of myofascial pain and dysfunction. In 2009, Stew became the   first massage therapist in the U.S. to certify as a Manual Trigger Point   Therapist (CMTPT) with Myopain Seminars. He has since developed a   100-hour manual trigger point therapy course and is the program&rsquo;s senior   lecturer. Stew serves as the Vice President of the Certification Board   of Myofascial Trigger Point Therapists (CBMTPT), is a regular presenter   for the National Association of Myofascial Trigger Point Therapists   (NAMTPT), has attended all three Fascia Research Congresses and belongs   to the International Myopain Society (IMS).</p>
          <p class="textInfoStyle">Stewart&rsquo;s medical background initially   began as a hematology laboratory technologist in 1973. He opened his   first massage clinic in Auckland, NZ in 1994. He later studied, then   taught the &lsquo;St. John version&rsquo; of NMT in New Zealand (1998-2003) and,   after moving to the United States, taught the &lsquo;American version&rsquo; for   Judith DeLany, of The NMT Center (2005-2009). He is currently developing   a 360 NMT Mastery Certification, encapsulating his many years of   clinical experience, study, research, and teaching.</p>
          <p class="textInfoStyle">During the &lsquo;80s and &lsquo;90s, Stewart was a   successful endurance cyclist, marathon runner, age-group duathlete and   triathlete (two Ironmans), representing New Zealand in many overseas   competitions. He continues to be an active hiker, skier, and   environmentalist, with keen interests in travel, epicure, and the arts.</p>
        </section>
      </div>
      <div class="accordion"> 
        <!-- Trigger -->
        <header>
          <div class="indicator" >&nbsp;</div>
          <h3>Katie Adams, CNMT, CMPT</h3>
        </header>
        
        <!-- Content Section -->
        <section class="content">    
            <p class="teamTxt"><span class="teamDetailPic"><img src="_images/team/katie.jpg" alt="Katie Adams" class=""></span><span class="hide_br"><br>
            </span>
         Katie Adams is a medically recognized leader in soft-tissue pain management. She founded 360 NeuroMuscular Therapy in 2004 to provide adjunct neuromuscular treatment for hospital medical practices, pain-focused physicians, physical therapists, chiropractors, and dentists. In 2006, she joined forces with colleague and now business partner Stewart Wild. Together, they have built the expertise and professional reputation of 360 NMT® as the only practice in Greater Boston exclusively focused on rehabilitation of soft-tissue dysfunction associated with medically diagnosed injury and myofascial pain syndrome.</p>
            <p class="teamTxt"> Katie holds a BA from Ithaca College and achieved national NMT certification in 1996 after graduating from the Massage Institute of New England. She specializes in manual trigger point deactivation and continues to train with physician-led organizations whose seminal research into pathophysiology of myofascial pain is revolutionizing the field. She is an active member of the <a href="http://www.amtamassage.org" target="new">American Massage Therapy Association</a>, the <a href="http://www.myofascialtherapy.org/" target="_blank">National Association of Trigger Point Therapists</a>, and the <a href="http://www.myopain.org">International Myopain Society</a>. </p>
            <p class="teamTxt">Katie is a regular speaker at medical conferences, including for the last four years,the <a href="http://www.nebh.org/for-health-professionals/boston-sports-symposium/" target="_blank">Boston Sports Medicine Symposium</a>. She is on the faculty of <a href="http://www.myopainseminars.com" target="_blank">Myopain Seminars</a> in Bethesda, MD, a  post-graduate, professional education program that teaches evidence-informed  treatment techniques and management of myofascial pain. She also presents in-services and small group courses for physical  therapy clinics and integrative medicine clinics. </p>
            <p class="teamTxt">A dancer at heart, Katie is passionate about helping restore pain-free movement for her patients. </p>
            <p class="teamTxt">She particularly enjoys resolving soft-tissue pain complications and compensations that can arise from surgical procedures. When not in the clinic room, she can be found in her garden growing roses and dahlias, or during winter months, snowshoeing with her pup Harry. </p>
    <p class="teamTxt">Check and subscribe to <a href="http://www.360nmt.com/blog/?cat=8" target="_blank">Katie's Blog</a> and <a href="https://twitter.com/KatieAdams360" target="_blank">Twitter</a> feed for latest news!</p>
        </section>
      </div>
      <div class="accordion"> 
        <!-- Trigger -->
        <header class="accbottom">
          <div class="indicator" >&nbsp;</div>
          <h3>Tom Kleinman, CNMT</h3>
        </header>
        
        <!-- Content Section -->
        <section class="content accordionBottomRadius" style="min-height:250px">
          <p class="textInfoStyle"><span class="teamDetailPic"><img src="_images/team/tom.jpg" alt="logo" width="163" height="239" class="right"></span><span class="hide_br">
<br>
</span>Tom Kleinman is a nationally certified NeuroMuscular Therapist (CNMT)   and certified Active Release Practitioner (ART). He holds a BA from the   University of Bridgeport and is a graduate of the Boulder College of   Massage Therapy (1994). </p>
          <p class="textInfoStyle teamDetailPic">Tom has extensive clinical experience   treating sports injuries. He worked with the NFL&rsquo;s Carolina Panthers   from 1995-1999, and more recently, has worked for over eight years at   the world-renowned Canyon Ranch Spa in the Berkshires. </p>
          <p class="textInfoStyle teamDetailPic">As an educator, Tom taught NMT at the   Southeastern School of Neuromuscular Therapy in Charlotte, and he also   instructed clinical anatomy and palpation at the Boulder College of   Massage.</p>
          <p class="textInfoStyle teamDetailPic">An avid mountain biker, Tom enjoys the   challenge of cycling at 7000-10,000 feet. He maintains a private   practice in Great Barrington, MA, where he also enjoys practicing yoga,   weight training, and spending time with his three children.        </p>
        </section>
      </div>
    </div>
  </div>
